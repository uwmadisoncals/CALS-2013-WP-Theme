...
/***** Main Parallax/position functions ******/
       ...
       function parallaxIt(obj,ratio,imgtype,following,header) {
          ...
          //console.log("parallaxit running");
          		...
          		var fsbgp = $(following).css("background-position");
          		//console.log(fsbgp); 
           ...
           $(window).scroll(function() {
             ...
             chromefix = setTimeout(function() {



              if($("body").hasClass("home")) {
              } else {
               $("body.Chrome").toggleClass("relative");
             }
             ...
             if(imgtype == "background") {
               ...
               if(offset<(newtop+wH) && (offset+objH)>(newtop-objH)) {
                 ...
                 $(following).css("background-position",headertranslate2);
               }
             } else {
                 //console.log(header);
                 //newtophalf = ""+(((newtop+(wH/2))-offset) * ratio) +"px";
       ...
       //if($("body").hasClass("home")) {
       		if(BrowserDetect.browser != "Firefox") {
       			parallaxIt($(".collegeFeature .slideImageSeperate"),0.8,'img',$(".collegeFeature .slideBlurImageInner"),true);
   			}
   		//}
