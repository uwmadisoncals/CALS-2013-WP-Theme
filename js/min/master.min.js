...
},disable:function(a){a=this._getIndex(a);var b=this.options;return a!=b.selected&&(this.lis.eq(a).addClass("ui-state-disabled"),b.disabled.push(a),b.disabled.sort(),this._trigger("disable",null,this._ui(this.anchors[a],this.panels[a]))),this},select:function(a){if(a=this._getIndex(a),-1==a){if(!this.options.collapsible||-1==this.options.selected)return this;a=this.options.selected}return this.anchors.eq(a).trigger(this.options.event+".tabs"),this},load:function(b){b=this._getIndex(b);var c=this,d=this.options,e=this.anchors.eq(b)[0],f=a.data(e,"load.tabs");if(this.abort(),f&&(0===this.element.queue("tabs").length||!a.data(e,"cache.tabs"))){if(this.lis.eq(b).addClass("ui-state-processing"),d.spinner){var g=a("span",e);g.data("label.tabs",g.html()).html(d.spinner)}return this.xhr=a.ajax(a.extend({},d.ajaxOptions,{url:f,success:function(f,g){c.element.find(c._sanitizeSelector(e.hash)).html(f),c._cleanup(),d.cache&&a.data(e,"cache.tabs",!0),c._trigger("load",null,c._ui(c.anchors[b],c.panels[b]));try{d.ajaxOptions.success(f,g)}catch(h){}},error:function(a,f){c._cleanup(),c._trigger("load",null,c._ui(c.anchors[b],c.panels[b]));try{d.ajaxOptions.error(a,f,b,e)}catch(g){}}})),c.element.dequeue("tabs"),this}this.element.dequeue("tabs")},abort:function(){return this.element.queue([]),this.panels.stop(!1,!0),this.element.queue("tabs",this.element.queue("tabs").splice(-2,2)),this.xhr&&(this.xhr.abort(),delete this.xhr),this._cleanup(),this},url:function(a,b){return this.anchors.eq(a).removeData("cache.tabs").data("load.tabs",b),this},length:function(){return this.anchors.length}}),a.extend(a.ui.tabs,{version:"1.8.16"}),a.extend(a.ui.tabs.prototype,{rotation:null,rotate:function(a,b){var c=this,d=this.options,e=c._rotate||(c._rotate=function(b){clearTimeout(c.rotation),c.rotation=setTimeout(function(){var a=d.selected;c.select(++a<c.anchors.length?a:0)},a),b&&b.stopPropagation()});return b=c._unrotate||(c._unrotate=b?function(){t=d.selected,e()}:function(a){a.clientX&&c.rotate(null)}),a?(this.element.bind("tabsshow",e),this.anchors.bind(d.event+".tabs",b),e()):(clearTimeout(c.rotation),this.element.unbind("tabsshow",e),this.anchors.unbind(d.event+".tabs",b),delete this._rotate,delete this._unrotate),this}})}(jQuery),function(a){var b=0,c=0,d=0,e=10,f=0,g="ontouchstart"in window,h="onorientationchange"in window,i=!1,j=!1,k=!1,l=!1,m=!1,n=!1,o=!1,p="pointer",q="pointer",r=new Array,s=new Array,t=new Array,u=new Array,v=new Array,w=new Array,x=new Array,y=new Array,z=new Array,A=new Array,B=new Array,C=new Array,D=new Array,E={showScrollbar:function(b,c){b.scrollbarHide&&a("."+c).css({opacity:b.scrollbarOpacity,filter:"alpha(opacity:"+100*b.scrollbarOpacity+")"})},hideScrollbar:function(a,b,c,d,f,g,h,i,j,k){if(a.scrollbar&&a.scrollbarHide)for(var l=c;c+25>l;l++)b[b.length]=E.hideScrollbarIntervalTimer(e*l,d[c],(c+24-l)/24,f,g,h,i,j,k,a)},hideScrollbarInterval:function(b,c,d,e,g,h,i,j,k){f=-1*b/B[j]*(g-h-i-e),E.setSliderOffset("."+d,f),a("."+d).css({opacity:k.scrollbarOpacity*c,filter:"alpha(opacity:"+k.scrollbarOpacity*c*100+")"})},slowScrollHorizontalInterval:function(b,c,d,e,g,h,i,j,k,l,m,n,o,p,q,r,s,t){if(t.infiniteSlider){if(d<=-1*B[q]){var u=a(b).width();if(d<=-1*C[q]){var v=-1*m[0];a(c).each(function(b){E.setSliderOffset(a(c)[b],v+r),b<n.length&&(n[b]=-1*v),v+=a(this).outerWidth(!0)}),d+=-1*n[0],A[q]=-1*n[0]+r,B[q]=A[q]+u-h,z[q]=0}else{var w=0,D=E.getSliderOffset(a(c[0]),"x");a(c).each(function(a){E.getSliderOffset(this,"x")<D&&(D=E.getSliderOffset(this,"x"),w=a)});var F=A[q]+u;E.setSliderOffset(a(c)[w],F),A[q]=-1*n[1]+r,B[q]=A[q]+u-h,n.splice(0,1),n.splice(n.length,0,-1*F+r),z[q]++}}if(d>=-1*A[q]||d>=0){var u=a(b).width();if(d>=0){var v=-1*m[0];for(a(c).each(function(b){E.setSliderOffset(a(c)[b],v+r),b<n.length&&(n[b]=-1*v),v+=a(this).outerWidth(!0)}),d-=-1*n[0],A[q]=-1*n[0]+r,B[q]=A[q]+u-h,z[q]=p;-1*n[0]-u+r>0;){var G=0,H=E.getSliderOffset(a(c[0]),"x");a(c).each(function(a){E.getSliderOffset(this,"x")>H&&(H=E.getSliderOffset(this,"x"),G=a)});var F=A[q]-a(c[G]).outerWidth(!0);E.setSliderOffset(a(c)[G],F),n.splice(0,0,-1*F+r),n.splice(n.length-1,1),A[q]=-1*n[0]+r,B[q]=A[q]+u-h,z[q]--,x[q]++}}if(0>d){var G=0,H=E.getSliderOffset(a(c[0]),"x");a(c).each(function(a){E.getSliderOffset(this,"x")>H&&(H=E.getSliderOffset(this,"x"),G=a)});var F=A[q]-a(c[G]).outerWidth(!0);E.setSliderOffset(a(c)[G],F),n.splice(0,0,-1*F+r),n.splice(n.length-1,1),A[q]=-1*n[0]+r,B[q]=A[q]+u-h,z[q]--}}}var I=!1,J=E.calcActiveOffset(t,d,n,h,z[q],p,l,q),F=(J+z[q]+p)%p;if(t.infiniteSlider?F!=y[q]&&(I=!0):J!=x[q]&&(I=!0),I){var K=new E.args(t,b,a(b).children(":eq("+F+")"),F,s,!0);a(b).parent().data("args",K),""!=t.onSlideChange&&t.onSlideChange(K)}if(x[q]=J,y[q]=F,d=Math.floor(d),E.setSliderOffset(b,d),t.scrollbar){f=Math.floor((-1*d-A[q]+r)/(B[q]-A[q]+r)*(i-j-g));var L=g-k;d>=-1*A[q]+r?(L=g-k- -1*f,E.setSliderOffset(a("."+e),0),a("."+e).css({width:L+"px"})):d<=-1*B[q]+1?(L=i-j-k-f,E.setSliderOffset(a("."+e),f),a("."+e).css({width:L+"px"})):(E.setSliderOffset(a("."+e),f),a("."+e).css({width:L+"px"}))}},slowScrollHorizontal:function(b,c,d,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v){var C=new Array,D=new Array,F=E.getSliderOffset(b,"x"),G=0,H=25/1024*j;frictionCoefficient=v.frictionCoefficient,elasticFrictionCoefficient=v.elasticFrictionCoefficient,snapFrictionCoefficient=v.snapFrictionCoefficient,g>5&&v.snapToChildren&&!t?G=1:-5>g&&v.snapToChildren&&!t&&(G=-1),-1*H>g?g=-1*H:g>H&&(g=H),a(b)[0]!==a(s)[0]&&(G=-1*G,g=-2*g);var I=z[p];if(v.infiniteSlider)var J=A[p],K=B[p];for(var L=new Array,M=new Array,N=0;N<o.length;N++)L[N]=o[N],N<c.length&&(M[N]=E.getSliderOffset(a(c[N]),"x"));for(;g>1||-1>g;){if(g*=frictionCoefficient,F+=g,(F>-1*A[p]||F<-1*B[p])&&!v.infiniteSlider&&(g*=elasticFrictionCoefficient,F+=g),v.infiniteSlider){if(-1*K>=F){for(var O=a(b).width(),P=0,Q=M[0],N=0;N<M.length;N++)M[N]<Q&&(Q=M[N],P=N);var R=J+O;M[P]=R,J=-1*L[1]+u,K=J+O-j,L.splice(0,1),L.splice(L.length,0,-1*R+u),I++}if(F>=-1*J){for(var O=a(b).width(),S=0,T=M[0],N=0;N<M.length;N++)M[N]>T&&(T=M[N],S=N);var R=J-a(c[S]).outerWidth(!0);M[S]=R,L.splice(0,0,-1*R+u),L.splice(L.length-1,1),J=-1*L[0]+u,K=J+O-j,I--}}C[C.length]=F,D[D.length]=g}var U=!1,V=E.calcActiveOffset(v,F,L,j,I,r,x[p],p),W=(V+I+r)%r;if(v.snapToChildren&&(v.infiniteSlider?W!=y[p]&&(U=!0):V!=x[p]&&(U=!0),0>G&&!U?(V++,V>=o.length&&!v.infinteSlider&&(V=o.length-1)):G>0&&!U&&(V--,0>V&&!v.infinteSlider&&(V=0))),v.snapToChildren||(F>-1*A[p]||F<-1*B[p])&&!v.infiniteSlider){for(F=E.getSliderOffset(b,"x"),C.splice(0,C.length);F<L[V]-.5||F>L[V]+.5;)F=(F-L[V])*snapFrictionCoefficient+L[V],C[C.length]=F;C[C.length]=L[V]}var X=1;C.length%2!=0&&(X=0);for(var Y=0;Y<d.length;Y++)clearTimeout(d[Y]);for(var Z=(V+I+r)%r,$=0,Y=X;Y<C.length;Y+=2)(Y==X||Math.abs(C[Y]-$)>1||Y>=C.length-2)&&($=C[Y],d[d.length]=E.slowScrollHorizontalIntervalTimer(e*Y,b,c,C[Y],f,i,j,k,l,m,V,n,o,q,r,p,u,Z,v));var U=!1,W=(V+z[p]+r)%r;v.infiniteSlider?W!=y[p]&&(U=!0):V!=x[p]&&(U=!0),""!=v.onSlideComplete&&(d[d.length]=E.onSlideCompleteTimer(e*(Y+1),v,b,a(b).children(":eq("+W+")"),W,p)),w[p]=d,E.hideScrollbar(v,d,Y,C,f,i,j,l,m,p)},onSlideComplete:function(b,c,d,e,f){var g=r[f]!=e?!0:!1,h=new E.args(b,a(c),d,e,e,g);a(c).parent().data("args",h),""!=b.onSlideComplete&&b.onSlideComplete(h),r[f]=e},getSliderOffset:function(b,c){var d=0;if(c="x"==c?4:5,!j||k||l)d=parseInt(a(b).css("left"),10);else{for(var e=new Array("-webkit-transform","-moz-transform","transform"),f=0;f<e.length;f++)if(void 0!=a(b).css(e[f])&&a(b).css(e[f]).length>0){var g=a(b).css(e[f]).split(",");break}d=parseInt(g[c],10)}return d},setSliderOffset:function(b,c){!j||k||l?a(b).css({left:c+"px"}):a(b).css({webkitTransform:"matrix(1,0,0,1,"+c+",0)",MozTransform:"matrix(1,0,0,1,"+c+",0)",transform:"matrix(1,0,0,1,"+c+",0)"})},setBrowserInfo:function(){null!=navigator.userAgent.match("WebKit")?(i=!0,p="-webkit-grab",q="-webkit-grabbing"):null!=navigator.userAgent.match("Gecko")?(o=!0,p="move",q="-moz-grabbing"):null!=navigator.userAgent.match("MSIE 7")?(k=!0,n=!0):null!=navigator.userAgent.match("MSIE 8")?(l=!0,n=!0):null!=navigator.userAgent.match("MSIE 9")&&(m=!0,n=!0)},has3DTransform:function(){var b=!1,c=a("<div />").css({webkitTransform:"matrix(1,1,1,1,1,1)",MozTransform:"matrix(1,1,1,1,1,1)",transform:"matrix(1,1,1,1,1,1)"});return""==c.attr("style")?b=!1:void 0!=c.attr("style")&&(b=!0),b},getSlideNumber:function(a,b,c){return(a-z[b]+c)%c},calcActiveOffset:function(a,b,c,d){for(var e,f=!1,g=new Array,h=0;h<c.length;h++)c[h]<=b&&c[h]>b-d&&(f||c[h]==b||(g[g.length]=c[h-1]),g[g.length]=c[h],f=!0);0==g.length&&(g[0]=c[c.length-1]);for(var i=d,j=0,h=0;h<g.length;h++){var k=Math.abs(b-g[h]);i>k&&(j=g[h],i=k)}for(var h=0;h<c.length;h++)j==c[h]&&(e=h);return e},changeSlide:function(b,c,d,f,g,h,i,j,k,l,m,n,o,p,q,r,s){E.autoSlidePause(o);for(var t=0;t<f.length;t++)clearTimeout(f[t]);var u=Math.ceil(s.autoSlideTransTimer/10)+1,v=E.getSliderOffset(c,"x"),A=n[b],B=A-v;if(s.infiniteSlider){b=(b-z[o]+2*q)%q;var C=!1;0==b&&2==q&&(b=q,n[b]=n[b-1]-a(d).eq(0).outerWidth(!0),C=!0),A=n[b],B=A-v;var D=new Array(n[b]-a(c).width(),n[b]+a(c).width());C&&n.splice(n.length-1,1);for(var F=0;F<D.length;F++)Math.abs(D[F]-v)<Math.abs(B)&&(B=D[F]-v)}var G,H,I=new Array;E.showScrollbar(s,g);for(var F=0;u>=F;F++)G=F,G/=u,G--,H=v+B*(Math.pow(G,5)+1),I[I.length]=H;for(var J=0,F=0;F<I.length;F++)if((0==F||Math.abs(I[F]-J)>1||F>=I.length-2)&&(J=I[F],f[F]=E.slowScrollHorizontalIntervalTimer(e*(F+1),c,d,I[F],g,h,i,j,k,l,b,m,n,p,q,o,r,b,s)),0==F&&""!=s.onSlideStart){var K=(x[o]+z[o]+q)%q;s.onSlideStart(new E.args(s,c,a(c).children(":eq("+K+")"),K,b,!1))}var L=!1,K=(b+z[o]+q)%q;s.infiniteSlider?K!=y[o]&&(L=!0):b!=x[o]&&(L=!0),L&&""!=s.onSlideComplete&&(f[f.length]=E.onSlideCompleteTimer(e*(F+1),s,c,a(c).children(":eq("+K+")"),K,o)),w[o]=f,E.hideScrollbar(s,f,F,I,g,h,i,k,l,o),E.autoSlide(c,d,f,g,h,i,j,k,l,m,n,o,p,q,r,s)},autoSlide:function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p){return p.autoSlide?(E.autoSlidePause(l),s[l]=setTimeout(function(){!p.infiniteSlider&&x[l]>k.length-1&&(x[l]=x[l]-n);var q=(x[l]+z[l]+n+1)%n;E.changeSlide(q,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p),E.autoSlide(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p)},p.autoSlideTimer+p.autoSlideTransTimer),void 0):!1},autoSlidePause:function(a){clearTimeout(s[a])},isUnselectable:function(b,c){return""!=c.unselectableSelector&&1==a(b).closest(c.unselectableSelector).size()?!0:!1},slowScrollHorizontalIntervalTimer:function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s){var t=setTimeout(function(){E.slowScrollHorizontalInterval(b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s)},a);return t},onSlideCompleteTimer:function(a,b,c,d,e,f){var g=setTimeout(function(){E.onSlideComplete(b,c,d,e,f)},a);return g},hideScrollbarIntervalTimer:function(a,b,c,d,e,f,g,h,i,j){var k=setTimeout(function(){E.hideScrollbarInterval(b,c,d,e,f,g,h,i,j)},a);return k},args:function(b,c,d,e,f,g){this.settings=b,this.data=a(c).parent().data("iosslider"),this.slideChanged=g,this.sliderObject=c,this.sliderContainerObject=a(c).parent(),this.currentSlideObject=d,this.currentSlideNumber=e+1,this.targetSlideObject=a(c).children(":eq("+f+")"),this.targetSlideNumber=f+1,this.currentSliderOffset=-1*E.getSliderOffset(c,"x");try{this.prevSlideNumber=void 0==a(c).parent().data("args")?b.startAtSlide:a(c).parent().data("args").prevSlideNumber==this.currentSlideNumber?a(c).parent().data("args").currentSlideNumber:a(c).parent().data("args").prevSlideNumber,this.prevSlideObject=a(c).children(":eq("+this.prevSlideNumber+")")}catch(h){}},preventDrag:function(a){a.preventDefault()},preventClick:function(a){return a.stopImmediatePropagation(),!1},enableClick:function(){return!0}};E.setBrowserInfo();var F={init:function(e,i){j=E.has3DTransform();var m=a.extend(!0,{elasticPullResistance:.6,frictionCoefficient:.92,elasticFrictionCoefficient:.6,snapFrictionCoefficient:.92,snapToChildren:!1,snapSlideCenter:!1,startAtSlide:1,scrollbar:!1,scrollbarDrag:!1,scrollbarHide:!0,scrollbarLocation:"top",scrollbarContainer:"",scrollbarOpacity:.4,scrollbarHeight:"4px",scrollbarBorder:"0",scrollbarMargin:"5px",scrollbarBackground:"#000",scrollbarBorderRadius:"100px",scrollbarShadow:"0 0 0 #000",scrollbarElasticPullResistance:.9,desktopClickDrag:!1,keyboardControls:!1,tabToAdvance:!1,responsiveSlideContainer:!0,responsiveSlides:!0,navSlideSelector:"",navPrevSelector:"",navNextSelector:"",autoSlideToggleSelector:"",autoSlide:!1,autoSlideTimer:5e3,autoSlideTransTimer:750,infiniteSlider:!1,stageCSS:{position:"relative",top:"0",left:"0",overflow:"hidden",zIndex:1},unselectableSelector:"",onSliderLoaded:"",onSliderUpdate:"",onSliderResize:"",onSlideStart:"",onSlideChange:"",onSlideComplete:""},e);return void 0==i&&(i=this),a(i).each(function(){function e(){E.autoSlidePause(i),ob=a(eb).find("a"),pb=a(eb).find("[onclick]"),qb=a(eb).find("*"),a(Y).css("width",""),a(Y).css("height",""),a(eb).css("width",""),P=a(eb).children().not("script").get(),Q=new Array,R=new Array,a(P).css("width",""),B[i]=0,O=new Array,H=a(Y).parent().width(),J=a(Y).outerWidth(!0),m.responsiveSlideContainer&&(J=a(Y).outerWidth(!0)>H?H:a(Y).outerWidth(!0)),a(Y).css({position:m.stageCSS.position,top:m.stageCSS.top,left:m.stageCSS.left,overflow:m.stageCSS.overflow,zIndex:m.stageCSS.zIndex,webkitPerspective:1e3,webkitBackfaceVisibility:"hidden",width:J}),a(m.unselectableSelector).css({cursor:"default"});for(var b=0;b<P.length;b++){Q[b]=a(P[b]).width(),R[b]=a(P[b]).outerWidth(!0);var c=R[b];m.responsiveSlides&&(c=R[b]>J?J+-1*(R[b]-Q[b]):Q[b],a(P[b]).css({width:c})),a(P[b]).css({webkitBackfaceVisibility:"hidden",position:"absolute",top:0}),O[b]=-1*B[i],B[i]=B[i]+c+(R[b]-Q[b])}m.snapSlideCenter&&(X=.5*(J-R[0]),m.responsiveSlides&&R[0]>J&&(X=0)),C[i]=2*B[i];for(var b=0;b<P.length;b++)E.setSliderOffset(a(P[b]),-1*O[b]+B[i]+X),O[b]=O[b]-B[i];if(!m.infiniteSlider&&!m.snapSlideCenter){for(var d=0;d<O.length&&!(O[d]<=-1*(2*B[i]-J));d++)hb=d;O.splice(hb+1,O.length),O[O.length]=-1*(2*B[i]-J)}for(var d=0;d<O.length;d++)_[d]=O[d];if(Z&&(m.startAtSlide=u[i].startAtSlide>O.length?O.length:u[i].startAtSlide,m.infiniteSlider?(m.startAtSlide=(u[i].startAtSlide-1+fb)%fb,x[i]=u[i].startAtSlide):(m.startAtSlide=u[i].startAtSlide-1<0?O.length-1:u[i].startAtSlide,x[i]=u[i].startAtSlide-1),y[i]=x[i]),A[i]=B[i]+X,a(eb).css({position:"relative",cursor:p,webkitPerspective:"0",webkitBackfaceVisibility:"hidden",width:B[i]+"px"}),nb=B[i],B[i]=2*B[i]-J+2*X,kb=J>nb?!0:!1,kb&&a(eb).css({cursor:"default"}),I=a(Y).parent().outerHeight(!0),K=a(Y).height(),m.responsiveSlideContainer&&(K=K>I?I:K),a(Y).css({height:K}),E.setSliderOffset(eb,O[x[i]]),m.infiniteSlider&&!kb){for(var e=(E.getSliderOffset(a(eb),"x"),(z[i]+fb)%fb*-1);0>e;){var f=0,h=E.getSliderOffset(a(P[0]),"x");a(P).each(function(a){E.getSliderOffset(this,"x")<h&&(h=E.getSliderOffset(this,"x"),f=a)});var k=A[i]+nb;E.setSliderOffset(a(P)[f],k),A[i]=-1*O[1]+X,B[i]=A[i]+nb-J,O.splice(0,1),O.splice(O.length,0,-1*k+X),e++}for(;-1*O[0]-nb+X>0&&m.snapSlideCenter&&Z;){var l=0,n=E.getSliderOffset(a(P[0]),"x");a(P).each(function(a){E.getSliderOffset(this,"x")>n&&(n=E.getSliderOffset(this,"x"),l=a)});var k=A[i]-R[l];E.setSliderOffset(a(P)[l],k),O.splice(0,0,-1*k+X),O.splice(O.length-1,1),A[i]=-1*O[0]+X,B[i]=A[i]+nb-J,z[i]--,x[i]++}}return E.setSliderOffset(eb,O[x[i]]),g||m.desktopClickDrag||a(eb).css({cursor:"default"}),m.scrollbar&&(a("."+V).css({margin:m.scrollbarMargin,overflow:"hidden",display:"none"}),a("."+V+" ."+W).css({border:m.scrollbarBorder}),L=parseInt(a("."+V).css("marginLeft"))+parseInt(a("."+V).css("marginRight")),M=parseInt(a("."+V+" ."+W).css("borderLeftWidth"),10)+parseInt(a("."+V+" ."+W).css("borderRightWidth"),10),F=""!=m.scrollbarContainer?a(m.scrollbarContainer).width():J,G=(F-L)/fb,m.scrollbarHide||(ab=m.scrollbarOpacity),a("."+V).css({position:"absolute",left:0,width:F-L+"px",margin:m.scrollbarMargin}),"top"==m.scrollbarLocation?a("."+V).css("top","0"):a("."+V).css("bottom","0"),a("."+V+" ."+W).css({borderRadius:m.scrollbarBorderRadius,background:m.scrollbarBackground,height:m.scrollbarHeight,width:G-M+"px",minWidth:m.scrollbarHeight,border:m.scrollbarBorder,webkitPerspective:1e3,webkitBackfaceVisibility:"hidden",position:"relative",opacity:ab,filter:"alpha(opacity:"+100*ab+")",boxShadow:m.scrollbarShadow}),E.setSliderOffset(a("."+V+" ."+W),Math.floor((-1*O[x[i]]-A[i]+X)/(B[i]-A[i]+X)*(F-L-G))),a("."+V).css({display:"block"}),o=a("."+V+" ."+W),s=a("."+V)),m.scrollbarDrag&&!kb&&a("."+V+" ."+W).css({cursor:p}),m.infiniteSlider&&(S=(B[i]+J)/3),""!=m.navSlideSelector&&a(m.navSlideSelector).each(function(b){a(this).css({cursor:"pointer"}),a(this).unbind(tb).bind(tb,function(){E.changeSlide(b,eb,P,j,W,G,J,F,L,M,_,O,i,S,fb,X,m)})}),""!=m.navPrevSelector&&(a(m.navPrevSelector).css({cursor:"pointer"}),a(m.navPrevSelector).unbind(tb).bind(tb,function(){var a=(x[i]+z[i]+fb)%fb;(a>0||m.infiniteSlider)&&E.changeSlide(a-1,eb,P,j,W,G,J,F,L,M,_,O,i,S,fb,X,m)})),""!=m.navNextSelector&&(a(m.navNextSelector).css({cursor:"pointer"}),a(m.navNextSelector).unbind(tb).bind(tb,function(){var a=(x[i]+z[i]+fb)%fb;(a<O.length-1||m.infiniteSlider)&&E.changeSlide(a+1,eb,P,j,W,G,J,F,L,M,_,O,i,S,fb,X,m)})),m.autoSlide&&!kb&&(""!=m.autoSlideToggleSelector&&(a(m.autoSlideToggleSelector).css({cursor:"pointer"}),a(m.autoSlideToggleSelector).unbind(tb).bind(tb,function(){lb?(E.autoSlide(eb,P,j,W,G,J,F,L,M,_,O,i,S,fb,X,m),lb=!1,a(m.autoSlideToggleSelector).removeClass("on")):(E.autoSlidePause(i),lb=!0,a(m.autoSlideToggleSelector).addClass("on"))})),lb||kb||E.autoSlide(eb,P,j,W,G,J,F,L,M,_,O,i,S,fb,X,m),g?a(Y).bind("touchend.iosSliderEvent",function(){lb||kb||E.autoSlide(eb,P,j,W,G,J,F,L,M,_,O,i,S,fb,X,m)}):(a(Y).bind("mouseenter.iosSliderEvent",function(){E.autoSlidePause(i)}),a(Y).bind("mouseleave.iosSliderEvent",function(){lb||kb||E.autoSlide(eb,P,j,W,G,J,F,L,M,_,O,i,S,fb,X,m)}))),a(Y).data("iosslider",{obj:ub,settings:m,scrollerNode:eb,slideNodes:P,numberOfSlides:fb,centeredSlideOffset:X,sliderNumber:i,originalOffsets:_,childrenOffsets:O,sliderMax:B[i],scrollbarClass:W,scrollbarWidth:G,scrollbarStageWidth:F,stageWidth:J,scrollMargin:L,scrollBorder:M,infiniteSliderOffset:z[i],infiniteSliderWidth:S}),Z=!1,!0}b++;var i=b,j=new Array;u[i]=m,A[i]=0,B[i]=0;var o,s,F,G,H,I,J,K,L,M,N,O,P,Q,R,S,T=new Array(0,0),U=new Array(0,0),V="scrollbarBlock"+b,W="scrollbar"+b,X=0,Y=a(this),Z=!0,$=-1,_=(new Array,new Array),ab=0,bb=0,cb=0,db=0,eb=a(this).children(":first-child"),fb=a(eb).children().not("script").size(),gb=!1,hb=0,ib=!1,jb=void 0;z[i]=0;var kb=!1;r[i]=-1;var lb=!1;t[i]=Y,v[i]=!1;var mb,nb,ob,pb,qb,rb=!1,sb=!1,tb=g?"touchstart.iosSliderEvent":"click.iosSliderEvent";D[i]=!1,w[i]=new Array,m.scrollbarDrag&&(m.scrollbar=!0,m.scrollbarHide=!1);var ub=a(this),vb=ub.data("iosslider");if(void 0!=vb)return!0;if(a(this).find("img").bind("dragstart.iosSliderEvent",function(a){a.preventDefault()}),m.infiniteSlider&&(m.scrollbar=!1),m.scrollbar&&(""!=m.scrollbarContainer?a(m.scrollbarContainer).append("<div class = '"+V+"'><div class = '"+W+"'></div></div>"):a(eb).parent().append("<div class = '"+V+"'><div class = '"+W+"'></div></div>")),!e())return!0;a(this).find("a").bind("mousedown",E.preventDrag),a(this).find("[onclick]").bind("click",E.preventDrag).each(function(){a(this).data("onclick",this.onclick)});var $=E.calcActiveOffset(m,E.getSliderOffset(a(eb),"x"),O,J,z[i],fb,void 0,i),wb=($+z[i]+fb)%fb,xb=new E.args(m,eb,a(eb).children(":eq("+wb+")"),wb,wb,!1);if(a(Y).data("args",xb),""!=m.onSliderLoaded&&m.onSliderLoaded(xb),r[i]=wb,u[i].responsiveSlides||u[i].responsiveSlideContainer){var yb=h?"orientationchange":"resize";a(window).bind(yb+".iosSliderEvent",function(){if(!e())return!0;var b=a(Y).data("args");""!=m.onSliderResize&&m.onSliderResize(b)})}if(!m.keyboardControls&&!m.tabToAdvance||kb||a(document).bind("keydown.iosSliderEvent",function(a){if(!k&&!l)var a=a.originalEvent;if(37==a.keyCode&&m.keyboardControls){a.preventDefault();var b=(x[i]+z[i]+fb)%fb;(b>0||m.infiniteSlider)&&E.changeSlide(b-1,eb,P,j,W,G,J,F,L,M,_,O,i,S,fb,X,m)}else if(39==a.keyCode&&m.keyboardControls||9==a.keyCode&&m.tabToAdvance){a.preventDefault();var b=(x[i]+z[i]+fb)%fb;(b<O.length-1||m.infiniteSlider)&&E.changeSlide(b+1,eb,P,j,W,G,J,F,L,M,_,O,i,S,fb,X,m)}}),g||m.desktopClickDrag){var zb=g?"touchstart.iosSliderEvent":"mousedown.iosSliderEvent",Ab=a(eb),Bb=a(eb),Cb=!1;m.scrollbarDrag&&(Ab=Ab.add(o),Bb=Bb.add(s)),a(Ab).bind(zb,function(b){if(D[i]||kb)return!0;if(Cb=E.isUnselectable(b.target,m))return!0;if(mb=a(this)[0]===a(o)[0]?o:eb,!k&&!l)var b=b.originalEvent;E.autoSlidePause(i),qb.unbind(".disableClick"),g?(eventX=b.touches[0].pageX,eventY=b.touches[0].pageY):(window.getSelection?window.getSelection().empty?window.getSelection().empty():window.getSelection().removeAllRanges&&window.getSelection().removeAllRanges():document.selection&&document.selection.empty(),eventX=b.pageX,eventY=b.pageY,ib=!0,jb=eb,a(this).css({cursor:q})),T=new Array(0,0),U=new Array(0,0),c=0,gb=!1;for(var d=0;d<j.length;d++)clearTimeout(j[d]);var e=E.getSliderOffset(eb,"x");e>-1*A[i]+X+nb?(e=-1*A[i]+X+nb,E.setSliderOffset(a("."+W),e),a("."+W).css({width:G-M+"px"})):e<-1*B[i]&&(e=-1*B[i],E.setSliderOffset(a("."+W),F-L-G),a("."+W).css({width:G-M+"px"}));var f=a(this)[0]===a(o)[0]?A[i]:0;bb=-1*(E.getSliderOffset(this,"x")-eventX-f),cb=-1*(E.getSliderOffset(this,"y")-eventY),T[1]=eventX,U[1]=eventY,sb=!1});var Db=g?"touchmove.iosSliderEvent":"mousemove.iosSliderEvent";if(a(Bb).bind(Db,function(b){if(!k&&!l)var b=b.originalEvent;if(D[i]||kb)return!0;if(Cb)return!0;var e=0;if(g||(window.getSelection?window.getSelection().empty?window.getSelection().empty():window.getSelection().removeAllRanges&&window.getSelection().removeAllRanges():document.selection&&document.selection.empty()),g)eventX=b.touches[0].pageX,eventY=b.touches[0].pageY;else{if(eventX=b.pageX,eventY=b.pageY,!ib)return!1;if(!n&&("undefined"!=typeof b.webkitMovementX||"undefined"!=typeof b.webkitMovementY)&&0===b.webkitMovementY&&0===b.webkitMovementX)return!1}if(T[0]=T[1],T[1]=eventX,c=(T[1]-T[0])/2,U[0]=U[1],U[1]=eventY,d=(U[1]-U[0])/2,!gb){var h=(x[i]+z[i]+fb)%fb,j=new E.args(m,eb,a(eb).children(":eq("+h+")"),h,h,!1);a(Y).data("args",j),""!=m.onSlideStart&&m.onSlideStart(j)}if((d>3||-3>d)&&3>c&&c>-3&&g&&!gb&&(rb=!0),(c>5||-5>c)&&g?(b.preventDefault(),gb=!0):g||(gb=!0),gb&&!rb){var o=E.getSliderOffset(eb,"x"),p=a(this)[0]===a(s)[0]?A[i]:X,q=a(this)[0]===a(s)[0]?(A[i]-B[i]-X)/(F-L-G):1,r=a(this)[0]===a(s)[0]?m.scrollbarElasticPullResistance:m.elasticPullResistance,t=m.snapSlideCenter&&a(this)[0]===a(s)[0]?0:X,u=m.snapSlideCenter&&a(this)[0]===a(s)[0]?X:0;if(g&&(db!=b.touches.length&&(bb=-1*o+eventX),db=b.touches.length),m.infiniteSlider){if(o<=-1*B[i]){var v=a(eb).width();if(o<=-1*C[i]){var w=-1*_[0];a(P).each(function(b){E.setSliderOffset(a(P)[b],w+X),b<O.length&&(O[b]=-1*w),w+=a(this).outerWidth(!0)}),bb-=-1*O[0],A[i]=-1*O[0]+X,B[i]=A[i]+v-J,z[i]=0}else{var H=0,I=E.getSliderOffset(a(P[0]),"x");a(P).each(function(a){E.getSliderOffset(this,"x")<I&&(I=E.getSliderOffset(this,"x"),H=a)});var K=A[i]+v;E.setSliderOffset(a(P)[H],K),A[i]=-1*O[1]+X,B[i]=A[i]+v-J,O.splice(0,1),O.splice(O.length,0,-1*K+X),z[i]++}}if(o>=-1*A[i]||o>=0){var v=a(eb).width();if(o>=0){var w=-1*_[0];for(a(P).each(function(b){E.setSliderOffset(a(P)[b],w+X),b<O.length&&(O[b]=-1*w),w+=a(this).outerWidth(!0)}),bb+=-1*O[0],A[i]=-1*O[0]+X,B[i]=A[i]+v-J,z[i]=fb;-1*O[0]-v+X>0;){var Q=0,R=E.getSliderOffset(a(P[0]),"x");a(P).each(function(a){E.getSliderOffset(this,"x")>R&&(R=E.getSliderOffset(this,"x"),Q=a)});var K=A[i]-a(P[Q]).outerWidth(!0);E.setSliderOffset(a(P)[Q],K),O.splice(0,0,-1*K+X),O.splice(O.length-1,1),A[i]=-1*O[0]+X,B[i]=A[i]+v-J,z[i]--,x[i]++}}else{var Q=0,R=E.getSliderOffset(a(P[0]),"x");a(P).each(function(a){E.getSliderOffset(this,"x")>R&&(R=E.getSliderOffset(this,"x"),Q=a)});var K=A[i]-a(P[Q]).outerWidth(!0);E.setSliderOffset(a(P)[Q],K),O.splice(0,0,-1*K+X),O.splice(O.length-1,1),A[i]=-1*O[0]+X,B[i]=A[i]+v-J,z[i]--}}}else{var v=a(eb).width();o>-1*A[i]+X&&(e=(A[i]+-1*(bb-p-eventX+t)*q-p)*r*-1/q),o<-1*B[i]&&(e=(B[i]+u+-1*(bb-p-eventX)*q-p)*r*-1/q)}if(E.setSliderOffset(eb,-1*(bb-p-eventX-e)*q-p+u),m.scrollbar){E.showScrollbar(m,W),f=Math.floor((bb-eventX-e-A[i]+t)/(B[i]-A[i]+X)*(F-L-G)*q);var S=G;o>=-1*A[i]+t+v?(S=G-M- -1*f,E.setSliderOffset(a("."+W),0),a("."+W).css({width:S+"px"})):o<=-1*B[i]+1?(S=F-L-M-f,E.setSliderOffset(a("."+W),f),a("."+W).css({width:S+"px"})):E.setSliderOffset(a("."+W),f)}g&&(N=b.touches[0].pageX);var V=!1,Z=E.calcActiveOffset(m,-1*(bb-eventX-e),O,J,z[i],fb,void 0,i),$=(Z+z[i]+fb)%fb;if(m.infiniteSlider?$!=y[i]&&(V=!0):Z!=x[i]&&(V=!0),V){x[i]=Z,y[i]=$,sb=!0;var j=new E.args(m,eb,a(eb).children(":eq("+$+")"),$,$,!0);a(Y).data("args",j),""!=m.onSlideChange&&m.onSlideChange(j)}}}),a(Ab).bind("touchend.iosSliderEvent",function(a){var a=a.originalEvent;if(D[i]||kb)return!0;if(Cb)return!0;if(0!=a.touches.length)for(var b=0;b<a.touches.length;b++)a.touches[b].pageX==N&&E.slowScrollHorizontal(eb,P,j,W,c,d,G,J,F,L,M,_,O,i,S,fb,mb,sb,X,m);else E.slowScrollHorizontal(eb,P,j,W,c,d,G,J,F,L,M,_,O,i,S,fb,mb,sb,X,m);rb=!1}),!g){var Eb=a(window);if(l||k)var Eb=a(document);a(Eb).bind("mouseup.iosSliderEvent"+i,function(){if(gb?ob.unbind("click.disableClick").bind("click.disableClick",E.preventClick):ob.unbind("click.disableClick").bind("click.disableClick",E.enableClick),pb.each(function(){this.onclick=function(b){return gb?!1:(a(this).data("onclick").call(this,b||window.event),void 0)}}),parseFloat(a().jquery)>=1.8?qb.each(function(){var b=a._data(this,"events");if(void 0!=b&&void 0!=b.click&&"iosSliderEvent"!=b.click[0].namespace){if(!gb)return!1;a(this).one("click.disableClick",E.preventClick);var c=a._data(this,"events").click,d=c.pop();c.splice(0,0,d)}}):parseFloat(a().jquery)>=1.6&&qb.each(function(){var b=a(this).data("events");if(void 0!=b&&void 0!=b.click&&"iosSliderEvent"!=b.click[0].namespace){if(!gb)return!1;a(this).one("click.disableClick",E.preventClick);var c=a(this).data("events").click,d=c.pop();c.splice(0,0,d)}}),!v[i]){if(kb)return!0;if(a(Ab).css({cursor:p}),ib=!1,void 0==jb)return!1;E.slowScrollHorizontal(jb,P,j,W,c,d,G,J,F,L,M,_,O,i,S,fb,mb,sb,X,m),jb=void 0}rb=!1})}}})},destroy:function(b,c){return void 0==c&&(c=this),a(c).each(function(){var c=a(this),d=c.data("iosslider");if(void 0==d)return!1;void 0==b&&(b=!0),E.autoSlidePause(d.sliderNumber),v[d.sliderNumber]=!0,a(window).unbind(".iosSliderEvent-"+d.sliderNumber),a(window).unbind(".iosSliderEvent"),a(document).unbind(".iosSliderEvent-"+d.sliderNumber),a(document).unbind("keydown.iosSliderEvent"),a(this).unbind(".iosSliderEvent"),a(this).children(":first-child").unbind(".iosSliderEvent"),a(this).children(":first-child").children().unbind(".iosSliderEvent"),b&&(a(this).attr("style",""),a(this).children(":first-child").attr("style",""),a(this).children(":first-child").children().attr("style",""),a(d.settings.navSlideSelector).attr("style",""),a(d.settings.navPrevSelector).attr("style",""),a(d.settings.navNextSelector).attr("style",""),a(d.settings.autoSlideToggleSelector).attr("style",""),a(d.settings.unselectableSelector).attr("style","")),d.settings.scrollbar&&a(".scrollbarBlock"+d.sliderNumber).remove();for(var e=w[d.sliderNumber],f=0;f<e.length;f++)clearTimeout(e[f]);c.removeData(["iosslider","args"])})},update:function(b){return void 0==b&&(b=this),a(b).each(function(){var b=a(this),c=b.data("iosslider");if(void 0==c)return!1;c.settings.startAtSlide=b.data("args").currentSlideNumber,F.destroy(!1,this),1!=c.numberOfSlides&&c.settings.infiniteSlider&&(c.settings.startAtSlide=(x[c.sliderNumber]+1+z[c.sliderNumber]+c.numberOfSlides)%c.numberOfSlides),F.init(c.settings,this);var d=new E.args(c.settings,c.scrollerNode,a(c.scrollerNode).children(":eq("+(c.settings.startAtSlide-1)+")"),c.settings.startAtSlide-1,c.settings.startAtSlide-1,!1);a(c.stageNode).data("args",d),""!=c.settings.onSliderUpdate&&c.settings.onSliderUpdate(d)})},addSlide:function(b,c){return this.each(function(){var d=a(this),e=d.data("iosslider");return void 0==e?!1:(e.settings.infiniteSlider?(1==c?a(e.scrollerNode).children(":eq(0)").before(b):a(e.scrollerNode).children(":eq("+(c-2)+")").after(b),z[e.sliderNumber]<-1&&x[e.sliderNumber]--,d.data("args").currentSlideNumber>=c&&x[e.sliderNumber]++):(c<=e.numberOfSlides?a(e.scrollerNode).children(":eq("+(c-1)+")").before(b):a(e.scrollerNode).children(":eq("+(c-2)+")").after(b),d.data("args").currentSlideNumber>=c&&d.data("args").currentSlideNumber++),d.data("iosslider").numberOfSlides++,F.update(this),void 0)})},removeSlide:function(b){return this.each(function(){var c=a(this),d=c.data("iosslider");return void 0==d?!1:(a(d.scrollerNode).children(":eq("+(b-1)+")").remove(),x[d.sliderNumber]>b-1&&x[d.sliderNumber]--,F.update(this),void 0)})},goToSlide:function(b,c){return void 0==c&&(c=this),a(c).each(function(){var c=a(this),d=c.data("iosslider");return void 0==d?!1:(b=b>d.childrenOffsets.length?d.childrenOffsets.length-1:b-1,E.changeSlide(b,a(d.scrollerNode),a(d.slideNodes),w[d.sliderNumber],d.scrollbarClass,d.scrollbarWidth,d.stageWidth,d.scrollbarStageWidth,d.scrollMargin,d.scrollBorder,d.originalOffsets,d.childrenOffsets,d.sliderNumber,d.infiniteSliderWidth,d.numberOfSlides,d.centeredSlideOffset,d.settings),x[d.sliderNumber]=b,void 0)})},lock:function(){return this.each(function(){var b=a(this),c=b.data("iosslider");return void 0==c?!1:(D[c.sliderNumber]=!0,void 0)})},unlock:function(){return this.each(function(){var b=a(this),c=b.data("iosslider");return void 0==c?!1:(D[c.sliderNumber]=!1,void 0)})},getData:function(){return this.each(function(){var b=a(this),c=b.data("iosslider");return void 0==c?!1:c})}};a.fn.iosSlider=function(b){return F[b]?F[b].apply(this,Array.prototype.slice.call(arguments,1)):"object"!=typeof b&&b?(a.error("invalid method call!"),void 0):F.init.apply(this,arguments)}}(jQuery),function(a,b){"use strict";var c,d=a.document,e=a.Modernizr,f=function(a){return a.charAt(0).toUpperCase()+a.slice(1)},g="Moz Webkit O Ms".split(" "),h=function(a){var b,c=d.documentElement.style;if("string"==typeof c[a])return a;a=f(a);for(var e=0,h=g.length;h>e;e++)if(b=g[e]+a,"string"==typeof c[b])return b},i=h("transform"),j=h("transitionProperty"),k={csstransforms:function(){return!!i},csstransforms3d:function(){var a=!!h("perspective");if(a){var c=" -o- -moz- -ms- -webkit- -khtml- ".split(" "),d="@media ("+c.join("transform-3d),(")+"modernizr)",e=b("<style>"+d+"{#modernizr{height:3px}}</style>").appendTo("head"),f=b('<div id="modernizr" />').appendTo("html");a=3===f.height(),f.remove(),e.remove()}return a},csstransitions:function(){return!!j}};if(e)for(c in k)e.hasOwnProperty(c)||e.addTest(c,k[c]);else{e=a.Modernizr={_version:"1.6ish: miniModernizr for Isotope"};var l,m=" ";for(c in k)l=k[c](),e[c]=l,m+=" "+(l?"":"no-")+c;b("html").addClass(m)}if(e.csstransforms){var n=e.csstransforms3d?{translate:function(a){return"translate3d("+a[0]+"px, "+a[1]+"px, 0) "},scale:function(a){return"scale3d("+a+", "+a+", 1) "}}:{translate:function(a){return"translate("+a[0]+"px, "+a[1]+"px) "},scale:function(a){return"scale("+a+") "}},o=function(a,c,d){var e,f,g=b.data(a,"isoTransform")||{},h={},j={};h[c]=d,b.extend(g,h);for(e in g)f=g[e],j[e]=n[e](f);var k=j.translate||"",l=j.scale||"",m=k+l;b.data(a,"isoTransform",g),a.style[i]=m};b.cssNumber.scale=!0,b.cssHooks.scale={set:function(a,b){o(a,"scale",b)},get:function(a){var c=b.data(a,"isoTransform");return c&&c.scale?c.scale:1}},b.fx.step.scale=function(a){b.cssHooks.scale.set(a.elem,a.now+a.unit)},b.cssNumber.translate=!0,b.cssHooks.translate={set:function(a,b){o(a,"translate",b)},get:function(a){var c=b.data(a,"isoTransform");return c&&c.translate?c.translate:[0,0]}}}var p,q;e.csstransitions&&(p={WebkitTransitionProperty:"webkitTransitionEnd",MozTransitionProperty:"transitionend",OTransitionProperty:"oTransitionEnd",transitionProperty:"transitionEnd"}[j],q=h("transitionDuration"));var r,s=b.event;s.special.smartresize={setup:function(){b(this).bind("resize",s.special.smartresize.handler)},teardown:function(){b(this).unbind("resize",s.special.smartresize.handler)
},handler:function(a,b){var c=this,d=arguments;a.type="smartresize",r&&clearTimeout(r),r=setTimeout(function(){jQuery.event.handle.apply(c,d)},"execAsap"===b?0:100)}},b.fn.smartresize=function(a){return a?this.bind("smartresize",a):this.trigger("smartresize",["execAsap"])},b.Isotope=function(a,c,d){this.element=b(c),this._create(a),this._init(d)};var t=["width","height"],u=b(a);b.Isotope.settings={resizable:!0,layoutMode:"masonry",containerClass:"isotope",itemClass:"isotope-item",hiddenClass:"isotope-hidden",hiddenStyle:{opacity:0,scale:.001},visibleStyle:{opacity:1,scale:1},containerStyle:{position:"relative",overflow:"hidden"},animationEngine:"best-available",animationOptions:{queue:!1,duration:800},sortBy:"original-order",sortAscending:!0,resizesContainer:!0,transformsEnabled:!b.browser.opera,itemPositionDataEnabled:!1},b.Isotope.prototype={_create:function(a){this.options=b.extend({},b.Isotope.settings,a),this.styleQueue=[],this.elemCount=0;var c=this.element[0].style;this.originalStyle={};var d=t.slice(0);for(var e in this.options.containerStyle)d.push(e);for(var f=0,g=d.length;g>f;f++)e=d[f],this.originalStyle[e]=c[e]||"";this.element.css(this.options.containerStyle),this._updateAnimationEngine(),this._updateUsingTransforms();var h={"original-order":function(a,b){return b.elemCount++,b.elemCount},random:function(){return Math.random()}};this.options.getSortData=b.extend(this.options.getSortData,h),this.reloadItems(),this.offset={left:parseInt(this.element.css("padding-left")||0,10),top:parseInt(this.element.css("padding-top")||0,10)};var i=this;setTimeout(function(){i.element.addClass(i.options.containerClass)},0),this.options.resizable&&u.bind("smartresize.isotope",function(){i.resize()}),this.element.delegate("."+this.options.hiddenClass,"click",function(){return!1})},_getAtoms:function(a){var b=this.options.itemSelector,c=b?a.filter(b).add(a.find(b)):a,d={position:"absolute"};return this.usingTransforms&&(d.left=0,d.top=0),c.css(d).addClass(this.options.itemClass),this.updateSortData(c,!0),c},_init:function(a){this.$filteredAtoms=this._filter(this.$allAtoms),this._sort(),this.reLayout(a)},option:function(a){if(b.isPlainObject(a)){this.options=b.extend(!0,this.options,a);var c;for(var d in a)c="_update"+f(d),this[c]&&this[c]()}},_updateAnimationEngine:function(){var a,b=this.options.animationEngine.toLowerCase().replace(/[ _\-]/g,"");switch(b){case"css":case"none":a=!1;break;case"jquery":a=!0;break;default:a=!e.csstransitions}this.isUsingJQueryAnimation=a,this._updateUsingTransforms()},_updateTransformsEnabled:function(){this._updateUsingTransforms()},_updateUsingTransforms:function(){var a=this.usingTransforms=this.options.transformsEnabled&&e.csstransforms&&e.csstransitions&&!this.isUsingJQueryAnimation;a||(delete this.options.hiddenStyle.scale,delete this.options.visibleStyle.scale),this.getPositionStyles=a?this._translate:this._positionAbs},_filter:function(a){var b=""===this.options.filter?"*":this.options.filter;if(!b)return a;var c=this.options.hiddenClass,d="."+c,e=a.filter(d),f=e;if("*"!==b){f=e.filter(b);var g=a.not(d).not(b).addClass(c);this.styleQueue.push({$el:g,style:this.options.hiddenStyle})}return this.styleQueue.push({$el:f,style:this.options.visibleStyle}),f.removeClass(c),a.filter(b)},updateSortData:function(a,c){var d,e,f=this,g=this.options.getSortData;a.each(function(){d=b(this),e={};for(var a in g)e[a]=c||"original-order"!==a?g[a](d,f):b.data(this,"isotope-sort-data")[a];b.data(this,"isotope-sort-data",e)})},_sort:function(){var a=this.options.sortBy,b=this._getSorter,c=this.options.sortAscending?1:-1,d=function(d,e){var f=b(d,a),g=b(e,a);return f===g&&"original-order"!==a&&(f=b(d,"original-order"),g=b(e,"original-order")),(f>g?1:g>f?-1:0)*c};this.$filteredAtoms.sort(d)},_getSorter:function(a,c){return b.data(a,"isotope-sort-data")[c]},_translate:function(a,b){return{translate:[a,b]}},_positionAbs:function(a,b){return{left:a,top:b}},_pushPosition:function(a,b,c){b=Math.round(b+this.offset.left),c=Math.round(c+this.offset.top);var d=this.getPositionStyles(b,c);this.styleQueue.push({$el:a,style:d}),this.options.itemPositionDataEnabled&&a.data("isotope-item-position",{x:b,y:c})},layout:function(a,b){var c=this.options.layoutMode;if(this["_"+c+"Layout"](a),this.options.resizesContainer){var d=this["_"+c+"GetContainerSize"]();this.styleQueue.push({$el:this.element,style:d})}this._processStyleQueue(a,b),this.isLaidOut=!0},_processStyleQueue:function(a,c){var d,f,g,h,i=this.isLaidOut?this.isUsingJQueryAnimation?"animate":"css":"css",j=this.options.animationOptions,k=this.options.onLayout;if(f=function(a,b){b.$el[i](b.style,j)},this._isInserting&&this.isUsingJQueryAnimation)f=function(a,b){d=b.$el.hasClass("no-transition")?"css":i,b.$el[d](b.style,j)};else if(c||k||j.complete){var l=!1,m=[c,k,j.complete],n=this;if(g=!0,h=function(){if(!l){for(var b,c=0,d=m.length;d>c;c++)b=m[c],"function"==typeof b&&b.call(n.element,a,n);l=!0}},this.isUsingJQueryAnimation&&"animate"===i)j.complete=h,g=!1;else if(e.csstransitions){for(var o,r=0,s=this.styleQueue[0],t=s&&s.$el;!t||!t.length;){if(o=this.styleQueue[r++],!o)return;t=o.$el}var u=parseFloat(getComputedStyle(t[0])[q]);u>0&&(f=function(a,b){b.$el[i](b.style,j).one(p,h)},g=!1)}}b.each(this.styleQueue,f),g&&h(),this.styleQueue=[]},resize:function(){this["_"+this.options.layoutMode+"ResizeChanged"]()&&this.reLayout()},reLayout:function(a){this["_"+this.options.layoutMode+"Reset"](),this.layout(this.$filteredAtoms,a)},addItems:function(a,b){var c=this._getAtoms(a);this.$allAtoms=this.$allAtoms.add(c),b&&b(c)},insert:function(a,b){this.element.append(a);var c=this;this.addItems(a,function(a){var d=c._filter(a);c._addHideAppended(d),c._sort(),c.reLayout(),c._revealAppended(d,b)})},appended:function(a,b){var c=this;this.addItems(a,function(a){c._addHideAppended(a),c.layout(a),c._revealAppended(a,b)})},_addHideAppended:function(a){this.$filteredAtoms=this.$filteredAtoms.add(a),a.addClass("no-transition"),this._isInserting=!0,this.styleQueue.push({$el:a,style:this.options.hiddenStyle})},_revealAppended:function(a,b){var c=this;setTimeout(function(){a.removeClass("no-transition"),c.styleQueue.push({$el:a,style:c.options.visibleStyle}),c._isInserting=!1,c._processStyleQueue(a,b)},10)},reloadItems:function(){this.$allAtoms=this._getAtoms(this.element.children())},remove:function(a,b){var c=this,d=function(){c.$allAtoms=c.$allAtoms.not(a),a.remove(),b&&b.call(c.element)};a.filter(":not(."+this.options.hiddenClass+")").length?(this.styleQueue.push({$el:a,style:this.options.hiddenStyle}),this.$filteredAtoms=this.$filteredAtoms.not(a),this._sort(),this.reLayout(d)):d()},shuffle:function(a){this.updateSortData(this.$allAtoms),this.options.sortBy="random",this._sort(),this.reLayout(a)},destroy:function(){var a=this.usingTransforms,b=this.options;this.$allAtoms.removeClass(b.hiddenClass+" "+b.itemClass).each(function(){var b=this.style;b.position="",b.top="",b.left="",b.opacity="",a&&(b[i]="")});var c=this.element[0].style;for(var d in this.originalStyle)c[d]=this.originalStyle[d];this.element.unbind(".isotope").undelegate("."+b.hiddenClass,"click").removeClass(b.containerClass).removeData("isotope"),u.unbind(".isotope")},_getSegments:function(a){var b,c=this.options.layoutMode,d=a?"rowHeight":"columnWidth",e=a?"height":"width",g=a?"rows":"cols",h=this.element[e](),i=this.options[c]&&this.options[c][d]||this.$filteredAtoms["outer"+f(e)](!0)||h;b=Math.floor(h/i),b=Math.max(b,1),this[c][g]=b,this[c][d]=i},_checkIfSegmentsChanged:function(a){var b=this.options.layoutMode,c=a?"rows":"cols",d=this[b][c];return this._getSegments(a),this[b][c]!==d},_masonryReset:function(){this.masonry={},this._getSegments();var a=this.masonry.cols;for(this.masonry.colYs=[];a--;)this.masonry.colYs.push(0)},_masonryLayout:function(a){var c=this,d=c.masonry;a.each(function(){var a=b(this),e=Math.ceil(a.outerWidth(!0)/d.columnWidth);if(e=Math.min(e,d.cols),1===e)c._masonryPlaceBrick(a,d.colYs);else{var f,g,h=d.cols+1-e,i=[];for(g=0;h>g;g++)f=d.colYs.slice(g,g+e),i[g]=Math.max.apply(Math,f);c._masonryPlaceBrick(a,i)}})},_masonryPlaceBrick:function(a,b){for(var c=Math.min.apply(Math,b),d=0,e=0,f=b.length;f>e;e++)if(b[e]===c){d=e;break}var g=this.masonry.columnWidth*d,h=c;this._pushPosition(a,g,h);var i=c+a.outerHeight(!0),j=this.masonry.cols+1-f;for(e=0;j>e;e++)this.masonry.colYs[d+e]=i},_masonryGetContainerSize:function(){var a=Math.max.apply(Math,this.masonry.colYs);return{height:a}},_masonryResizeChanged:function(){return this._checkIfSegmentsChanged()},_fitRowsReset:function(){this.fitRows={x:0,y:0,height:0}},_fitRowsLayout:function(a){var c=this,d=this.element.width(),e=this.fitRows;a.each(function(){var a=b(this),f=a.outerWidth(!0),g=a.outerHeight(!0);0!==e.x&&f+e.x>d&&(e.x=0,e.y=e.height),c._pushPosition(a,e.x,e.y),e.height=Math.max(e.y+g,e.height),e.x+=f})},_fitRowsGetContainerSize:function(){return{height:this.fitRows.height}},_fitRowsResizeChanged:function(){return!0},_cellsByRowReset:function(){this.cellsByRow={index:0},this._getSegments(),this._getSegments(!0)},_cellsByRowLayout:function(a){var c=this,d=this.cellsByRow;a.each(function(){var a=b(this),e=d.index%d.cols,f=Math.floor(d.index/d.cols),g=(e+.5)*d.columnWidth-a.outerWidth(!0)/2,h=(f+.5)*d.rowHeight-a.outerHeight(!0)/2;c._pushPosition(a,g,h),d.index++})},_cellsByRowGetContainerSize:function(){return{height:Math.ceil(this.$filteredAtoms.length/this.cellsByRow.cols)*this.cellsByRow.rowHeight+this.offset.top}},_cellsByRowResizeChanged:function(){return this._checkIfSegmentsChanged()},_straightDownReset:function(){this.straightDown={y:0}},_straightDownLayout:function(a){var c=this;a.each(function(){var a=b(this);c._pushPosition(a,0,c.straightDown.y),c.straightDown.y+=a.outerHeight(!0)})},_straightDownGetContainerSize:function(){return{height:this.straightDown.y}},_straightDownResizeChanged:function(){return!0},_masonryHorizontalReset:function(){this.masonryHorizontal={},this._getSegments(!0);var a=this.masonryHorizontal.rows;for(this.masonryHorizontal.rowXs=[];a--;)this.masonryHorizontal.rowXs.push(0)},_masonryHorizontalLayout:function(a){var c=this,d=c.masonryHorizontal;a.each(function(){var a=b(this),e=Math.ceil(a.outerHeight(!0)/d.rowHeight);if(e=Math.min(e,d.rows),1===e)c._masonryHorizontalPlaceBrick(a,d.rowXs);else{var f,g,h=d.rows+1-e,i=[];for(g=0;h>g;g++)f=d.rowXs.slice(g,g+e),i[g]=Math.max.apply(Math,f);c._masonryHorizontalPlaceBrick(a,i)}})},_masonryHorizontalPlaceBrick:function(a,b){for(var c=Math.min.apply(Math,b),d=0,e=0,f=b.length;f>e;e++)if(b[e]===c){d=e;break}var g=c,h=this.masonryHorizontal.rowHeight*d;this._pushPosition(a,g,h);var i=c+a.outerWidth(!0),j=this.masonryHorizontal.rows+1-f;for(e=0;j>e;e++)this.masonryHorizontal.rowXs[d+e]=i},_masonryHorizontalGetContainerSize:function(){var a=Math.max.apply(Math,this.masonryHorizontal.rowXs);return{width:a}},_masonryHorizontalResizeChanged:function(){return this._checkIfSegmentsChanged(!0)},_fitColumnsReset:function(){this.fitColumns={x:0,y:0,width:0}},_fitColumnsLayout:function(a){var c=this,d=this.element.height(),e=this.fitColumns;a.each(function(){var a=b(this),f=a.outerWidth(!0),g=a.outerHeight(!0);0!==e.y&&g+e.y>d&&(e.x=e.width,e.y=0),c._pushPosition(a,e.x,e.y),e.width=Math.max(e.x+f,e.width),e.y+=g})},_fitColumnsGetContainerSize:function(){return{width:this.fitColumns.width}},_fitColumnsResizeChanged:function(){return!0},_cellsByColumnReset:function(){this.cellsByColumn={index:0},this._getSegments(),this._getSegments(!0)},_cellsByColumnLayout:function(a){var c=this,d=this.cellsByColumn;a.each(function(){var a=b(this),e=Math.floor(d.index/d.rows),f=d.index%d.rows,g=(e+.5)*d.columnWidth-a.outerWidth(!0)/2,h=(f+.5)*d.rowHeight-a.outerHeight(!0)/2;c._pushPosition(a,g,h),d.index++})},_cellsByColumnGetContainerSize:function(){return{width:Math.ceil(this.$filteredAtoms.length/this.cellsByColumn.rows)*this.cellsByColumn.columnWidth}},_cellsByColumnResizeChanged:function(){return this._checkIfSegmentsChanged(!0)},_straightAcrossReset:function(){this.straightAcross={x:0}},_straightAcrossLayout:function(a){var c=this;a.each(function(){var a=b(this);c._pushPosition(a,c.straightAcross.x,0),c.straightAcross.x+=a.outerWidth(!0)})},_straightAcrossGetContainerSize:function(){return{width:this.straightAcross.x}},_straightAcrossResizeChanged:function(){return!0}},b.fn.imagesLoaded=function(a){function c(){a.call(e,f)}function d(a){var e=a.target;e.src!==h&&-1===b.inArray(e,i)&&(i.push(e),--g<=0&&(setTimeout(c),f.unbind(".imagesLoaded",d)))}var e=this,f=e.find("img").add(e.filter("img")),g=f.length,h="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==",i=[];return g||c(),f.bind("load.imagesLoaded error.imagesLoaded",d).each(function(){var a=this.src;this.src=h,this.src=a}),e};var v=function(b){a.console&&a.console.error(b)};b.fn.isotope=function(a,c){if("string"==typeof a){var d=Array.prototype.slice.call(arguments,1);this.each(function(){var c=b.data(this,"isotope");return c?b.isFunction(c[a])&&"_"!==a.charAt(0)?(c[a].apply(c,d),void 0):(v("no such method '"+a+"' for isotope instance"),void 0):(v("cannot call methods on isotope prior to initialization; attempted to call method '"+a+"'"),void 0)})}else this.each(function(){var d=b.data(this,"isotope");d?(d.option(a),d._init(c)):b.data(this,"isotope",new b.Isotope(a,this,c))});return this}}(window,jQuery),function(a){function b(a){for(var b,c=["transform","WebkitTransform","msTransform","MozTransform","OTransform"];b=c.shift();)if("undefined"!=typeof a.style[b])return b;return"transform"}var c=null,d=a.fn.css;a.fn.css=function(e,f){if(null===c&&(c="undefined"!=typeof a.cssProps?a.cssProps:"undefined"!=typeof a.props?a.props:{}),"undefined"==typeof c.transform&&("transform"==e||"object"==typeof e&&"undefined"!=typeof e.transform)&&(c.transform=b(this.get(0))),"transform"!=c.transform)if("transform"==e){if(e=c.transform,"undefined"==typeof f&&jQuery.style)return jQuery.style(this.get(0),e)}else"object"==typeof e&&"undefined"!=typeof e.transform&&(e[c.transform]=e.transform,delete e.transform);return d.apply(this,arguments)}}(jQuery),function(a){var b="deg";a.fn.rotate=function(c){var d=a(this).css("transform")||"none";if("undefined"==typeof c){if(d){var e=d.match(/rotate\(([^)]+)\)/);if(e&&e[1])return e[1]}return 0}var e=c.toString().match(/^(-?\d+(\.\d+)?)(.+)?$/);return e&&(e[3]&&(b=e[3]),a(this).css("transform",d.replace(/none|rotate\([^)]*\)/,"")+"rotate("+e[1]+b+")")),this},a.fn.scale=function(b){var c=a(this).css("transform");if("undefined"==typeof b){if(c){var d=c.match(/scale\(([^)]+)\)/);if(d&&d[1])return d[1]}return 1}return a(this).css("transform",c.replace(/none|scale\([^)]*\)/,"")+"scale("+b+")"),this};var c=a.fx.prototype.cur;a.fx.prototype.cur=function(){return"rotate"==this.prop?parseFloat(a(this.elem).rotate()):"scale"==this.prop?parseFloat(a(this.elem).scale()):c.apply(this,arguments)},a.fx.step.rotate=function(c){a(c.elem).rotate(c.now+b)},a.fx.step.scale=function(b){a(b.elem).scale(b.now)};var d=a.fn.animate;a.fn.animate=function(a){if("undefined"!=typeof a.rotate){var c=a.rotate.toString().match(/^(([+-]=)?(-?\d+(\.\d+)?))(.+)?$/);c&&c[5]&&(b=c[5]),a.rotate=c[1]}return d.apply(this,arguments)}}(jQuery);var BrowserDetect={init:function(){this.browser=this.searchString(this.dataBrowser)||"An unknown browser",this.version=this.searchVersion(navigator.userAgent)||this.searchVersion(navigator.appVersion)||"an unknown version",this.OS=this.searchString(this.dataOS)||"an unknown OS"},searchString:function(a){for(var b=0;b<a.length;b++){var c=a[b].string,d=a[b].prop;if(this.versionSearchString=a[b].versionSearch||a[b].identity,c){if(-1!=c.indexOf(a[b].subString))return a[b].identity}else if(d)return a[b].identity}},searchVersion:function(a){var b=a.indexOf(this.versionSearchString);if(-1!=b)return parseFloat(a.substring(b+this.versionSearchString.length+1))},dataBrowser:[{string:navigator.userAgent,subString:"Chrome",identity:"Chrome"},{string:navigator.userAgent,subString:"OmniWeb",versionSearch:"OmniWeb/",identity:"OmniWeb"},{string:navigator.vendor,subString:"Apple",identity:"Safari",versionSearch:"Version"},{prop:window.opera,identity:"Opera",versionSearch:"Version"},{string:navigator.vendor,subString:"iCab",identity:"iCab"},{string:navigator.vendor,subString:"KDE",identity:"Konqueror"},{string:navigator.userAgent,subString:"Firefox",identity:"Firefox"},{string:navigator.vendor,subString:"Camino",identity:"Camino"},{string:navigator.userAgent,subString:"Netscape",identity:"Netscape"},{string:navigator.userAgent,subString:"MSIE",identity:"Explorer",versionSearch:"MSIE"},{string:navigator.userAgent,subString:"Gecko",identity:"Mozilla",versionSearch:"rv"},{string:navigator.userAgent,subString:"Mozilla",identity:"Netscape",versionSearch:"Mozilla"}],dataOS:[{string:navigator.platform,subString:"Win",identity:"Windows"},{string:navigator.platform,subString:"Mac",identity:"Mac"},{string:navigator.userAgent,subString:"iPhone",identity:"iPhone/iPod"},{string:navigator.platform,subString:"Linux",identity:"Linux"}]};BrowserDetect.init(),$(function(){function a(){$("#page .box").each(function(){var a=$(this).find("img").first(),b=$(a).height(),c=$(a).width(),d=c/b,e=$(this).height(),f=$(this).width(),g=f/e;g>=d?($(a).css("width","100%"),$(a).css("height","auto")):($(a).css("height","100%"),$(a).css("width","auto"))})}function b(){var a=$("#colophon"),b=0,c=$("body").height(),d=$(window).height(),e=a.height();a.hasClass("fixedBottom")?(console.log(c+e+b+" : "+d),d>c+e+b||a.removeClass("fixedBottom")):d>c&&a.addClass("fixedBottom")}function c(){d();var a=$(".collegeFeature ul li").width();"slide"==t&&($(".collegeFeature li:last-child").hasClass("active")?$(".collegeFeature ul").animate({left:"0px"},500):$(".collegeFeature ul").animate({left:"-="+a+"px"},500)),$(".collegeFeature li").each(function(){if($(this).hasClass("active")&&$(this).attr("data-count")<o){var a=$(this);return $(a).next().addClass("active"),$(a).removeClass("active"),"crossdissolve"==t&&($(a).next().css("left","0px"),$(a).next().animate({opacity:1},1e3,function(){$(a).css("opacity","0"),$(a).css("left","100000px")})),!1}if($(this).hasClass("active")&&$(this).attr("data-count")==o){var a=$(this);return $(a).removeClass("active"),"crossdissolve"==t&&($(".collegeFeature li:first-child").css("opacity","1"),$(".collegeFeature li:first-child").css("left","0px"),$(a).animate({opacity:0},1e3,function(){$(a).css("left","10000000px")})),$(".collegeFeature li:first-child").addClass("active"),!1}})}function d(){clearTimeout(y),"Explorer"==BrowserDetect.browser||"Firefox"==BrowserDetect.browser||($(".collegeFeature .timer1").stop().rotate("0deg"),$(".collegeFeature .timer2").stop().rotate("0deg"),$(".collegeFeature .timer2").animate({rotate:"180deg"},A,"linear"),y=setTimeout(function(){$(".collegeFeature .timer1").animate({rotate:"180deg"},A,"linear",function(){})},A))}function e(){setTimeout(function(){if($("#container").animate({opacity:1},500),g(L))var a=g(L);if(g(M))var a=g(M);if($(".newsItem.twitter")){var b=$(".newsItem.twitter .titleheading a").last().attr("href"),c="Learn more about how "+$(".newsItem.twitter .titleheading h3").text();b&&($(".newsItem.twitter .highlight").attr("href",b),$(".newsItem.twitter .highlight").attr("title",c),$(".newsItem.twitter .highlight").text(c))}$(".newsItem").each(function(){var b=($(this),$(this).find(".titleheading").text()),c=$(this).find(".excerpt").text(),d=c.substring(0,50);a&&(b==a||d==a)&&($(this).addClass("duplicate"),a=""),$(this).find(".excerpt a").remove();var e=$(this).find(".excerpt").text();if(e=h(e),0==e.length)$(this).addClass("noexcerpt");else{e=e.slice(0,-2);var f="<p>"+e.substring(0,120)+"&#8230;</p>";$(this).find(".excerpt").html(f)}if("Explorer"!=BrowserDetect.browser){var g=($(this).find(".excerpt").html(),$(this).find(".excerpt").height());g=1.3*g}}),T||(T="chronological"),J.isotope({masonry:{columnWidth:316},sortBy:T,getSortData:{number:function(a){var b=a.hasClass("newsItem")?a.find(".number").text():a.attr("data-number");return parseInt(b,10)},alphabetical:function(a){var b=a.find("h3"),c=b.length?b:a;return c.text()},chronological:function(a){var b=a.find(".hiddendate").text();return parseInt(b)},grouped:function(a){var b=a.find(".hiddengroup").text();return b}}})},500)}function f(){T||(T="chronological"),J.isotope({masonry:{columnWidth:316},sortBy:T,getSortData:{number:function(a){var b=a.hasClass("newsItem")?a.find(".number").text():a.attr("data-number");return parseInt(b,10)},alphabetical:function(a){var b=a.find("h3"),c=b.length?b:a;return c.text()},chronological:function(a){var b=a.find(".hiddendate").text();return parseInt(b)},grouped:function(a){var b=a.find(".hiddengroup").text();return b}}})}function g(a){var b,c,d;for(d=a.length,b=0;d>b;b++)for(c=b+1;d>c;c++)if(a[b]==a[c])return a[b];return!1}function h(a){a=a.replace(/^\s+/,"");for(var b=a.length-1;b>=0;b--)if(/\S/.test(a.charAt(b))){a=a.substring(0,b+1);break}return a}function i(a,b){k()&&localStorage.setItem(a,b)}function k(){try{return"localStorage"in window&&null!==window.localStorage}catch(a){return!1}}function l(){if("no"==db){db="yes";var a=document.createElement("script");a.type="text/javascript",document.body.appendChild(a),a.src="//hi.kickassapp.com/kickass.js"}}$("#mobile-menu a").each(function(){$(this).addClass($(this).text())});var m=$(window).height();$("#mobile-menu-inner").height(m),setTimeout(function(){if($("body").hasClass("home")){var a=$("#main").html();$(".blurredBodyCopy .middle").html(a)}},1e3),$(window).scroll(function(){var a=$(window).scrollTop();a="-"+a+"px",newtranslate="translate(0px,"+a+")",$(".blurredBodyCopy").css("transform",newtranslate)}),a(),setTimeout(function(){a()},1e3);var n,o=0,p=localStorage.getItem("ieWarning"),q=navigator.userAgent;n=q.indexOf("Trident/5.0")>-1?q.indexOf("MSIE 7.0")>-1?"IE9 Compatibility View":"IE9":q.indexOf("Trident/4.0")>-1?q.indexOf("MSIE 7.0")>-1?"IE8 Compatibility View":"IE8":"IE7",("IE9 Compatibility View"==n||"IE8 Compatibility View"==n)&&"dismiss"!=p&&$(".ieWarning").slideDown(),$(".ieWarningDismiss").click(function(a){a.preventDefault(),$(".ieWarning").slideUp(),localStorage.setItem("ieWarning","dismiss")}),$(".ieWarningDismissOnce").click(function(a){a.preventDefault(),$(".ieWarning").slideUp()}),setTimeout(function(){$("body").toggleClass("relative")},3e3),setTimeout(function(){$("body").toggleClass("relative")},6e3),b(),$(".headeroverlay, .headerbgBlur, .headerbgBlurImage").height($(".navWrapper").height()),$(".headerbgBlur, .headerbgBlurImage").width($(".navWrapper").width()),$(window).resize(function(){b(),a();var c=$(window).height();$("#mobile-menu-inner").height(c),$(".headeroverlay, .headerbgBlur, .headerbgBlurImage").height($(".navWrapper").height()),$(".headerbgBlur, .headerbgBlurImage").width($(".navWrapper").width()),$(".mobileNavTriggerLarge").hide(),$(".mobileScroll").css("-webkit-transition","0.3s"),$(".mobileScroll").css("-webkit-transform",""),$("#mobile-menu").css("-webkit-transition","0.3s"),$("#mobile-menu").css("-webkit-transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("-webkit-transition","0.3s"),$("#mobile-menu-inner").css("-webkit-transform","scale(0.8)"),$(".mobileScroll").css("-moz-transition","0.3s"),$(".mobileScroll").css("-moz-transform",""),$("#mobile-menu").css("-moz-transition","0.3s"),$("#mobile-menu").css("-moz-transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("-moz-transition","0.3s"),$("#mobile-menu-inner").css("-moz-transform","scale(0.8)"),$(".mobileScroll").css("transition","0.3s"),$(".mobileScroll").css("transform",""),$("#mobile-menu").css("transition","0.3s"),$("#mobile-menu").css("transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("transition","0.3s"),$("#mobile-menu-inner").css("transform","scale(0.8)")}),$(".newsItem .additionalContent").each(function(){var a=$(this).children().hasClass("noImageSpacer2");a||$(this).next().addClass("imagePresent")}),$(".box a").click(function(){$(this).closest(".box").find("img").addClass("blurAnim"),$(this).closest(".box").find(".windows8").show(),$(this).closest(".box").find(".shade").fadeIn(400)});var r=$(".collegeFeature").html();if(r){var s=$(".headertransition").height();blurbarheightmod=s+10,s+="px",blurbarheightmod+="px",$(".slideBlurImage").css("height",blurbarheightmod),$(".slideBlur").css("height",s);var t="crossdissolve";$(".collegeFeature").addClass(t);var u="";"slide"==t?$(".collegeFeature li").each(function(){o+=1,u+="<div class='item item"+o+"'><div class='inner'>"+$(this).html()+"</div></div>",$(this).attr("data-count",o),$(this).css("z-index",o),$(this).addClass("active"),1!=$(this).attr("data-count")&&$(this).removeClass("active")}):$(".collegeFeature li").each(function(){o+=1,u+="<div class='item item"+o+"'><div class='inner'>"+$(this).html()+"</div></div>";$(this).attr("data-count",o),$(this).css("z-index",o),$(this).addClass("active"),1!=$(this).attr("data-count")&&($(this).removeClass("active"),$(this).css("opacity","0"),$(this).css("left","100000px"))});var v=$(window).width()+"px";$(".collegeFeature ul li").css("width",v);var w=v+" auto";$(".headerbgBlurImage").css("background-size",w),$(window).resize(function(){var a=$(window).width()+"px",b=a+" auto";$(".collegeFeature ul li").css("width",a),$(".headerbgBlurImage").css("background-size",b)}),$(".iosSlider .slider").html(u);var x,y,z=2e4,A=z/2;x=setInterval(function(){c()},z);var B=$("body").hasClass("home");(1==o||0==B)&&($(".timer, .collegeFeature .next, .collegeFeature .previous").hide(),clearInterval(x)),d(),$(".collegeFeature .next").click(function(){if(C||(clearTimeout(x),x=setInterval(function(){c($(this))},z),d()),"slide"==t){var a=$(".collegeFeature ul li").width();$(".collegeFeature li").each(function(){if($(this).hasClass("active")&&$(this).attr("data-count")<o){var b=$(this);return $(b).next().addClass("active"),$(b).removeClass("active"),$(".collegeFeature ul").animate({left:"-="+a+"px"},500),!1}if($(this).hasClass("active")&&$(this).attr("data-count")==o){var b=$(this);return $(b).removeClass("active"),$(".collegeFeature li:first-child").addClass("active"),$(".collegeFeature ul").animate({left:"0px"},500),!1}})}else $(".collegeFeature li").each(function(){if($(this).hasClass("active")&&$(this).attr("data-count")<o){var a=$(this);return $(a).next().css("left","0px"),$(a).next().animate({opacity:1},1e3,function(){$(a).css("opacity","0"),$(a).css("left","1000000px")}),$(a).next().addClass("active"),$(a).removeClass("active"),!1}if($(this).hasClass("active")&&$(this).attr("data-count")==o){var a=$(this);return $(a).removeClass("active"),$(".collegeFeature li:first-child").css("opacity","1"),$(".collegeFeature li:first-child").css("left","0px"),$(a).animate({opacity:0},1e3,function(){$(a).css("left","100000px")}),$(".collegeFeature li:first-child").addClass("active"),!1}});return!1}),$(".collegeFeature .previous").click(function(){C||(clearTimeout(x),x=setInterval(function(){c(this)},z),d());var a=$(".collegeFeature ul li").width();return"slide"==t?$(".collegeFeature li").each(function(){if($(this).hasClass("active")&&1!=$(this).attr("data-count")){var b=$(this);return $(b).prev().addClass("active"),$(b).removeClass("active"),$(".collegeFeature ul").animate({left:"+="+a+"px"},500),!1}if($(this).hasClass("active")&&1==$(this).attr("data-count")){var b=$(this);return $(b).removeClass("active"),$(".collegeFeature li:last-child").addClass("active"),$(".collegeFeature ul").animate({left:"-2814px"},500),!1}}):$(".collegeFeature li").each(function(){if($(this).hasClass("active")&&1!=$(this).attr("data-count")){var a=$(this);return $(a).prev().addClass("active"),$(a).prev().css("left","0px"),$(a).removeClass("active"),$(a).prev().css("opacity","1"),$(a).animate({opacity:0},1e3,function(){$(a).css("left","100000px")}),!1}if($(this).hasClass("active")&&1==$(this).attr("data-count")){var a=$(this);return $(a).removeClass("active"),$(".collegeFeature li:last-child").addClass("active"),$(".collegeFeature li:last-child").css("left","0px"),$(".collegeFeature li:last-child").animate({opacity:1},1e3,function(){$(a).css("opacity","0"),$(a).css("left","100000px")}),!1}}),!1});var C=!1;if($(".collegeFeature .timer a").click(function(){return C?(d(),x=setInterval(function(){c()},z),$(this).removeClass("paused"),i("mainslider","play"),C=!1):(clearTimeout(x),clearTimeout(y),$(".collegeFeature .timer1").stop().animate({rotate:"0deg"},200,"linear"),setTimeout(function(){$(".collegeFeature .timer2").stop().animate({rotate:"0deg"},200,"linear",function(){})},200),$(this).addClass("paused"),C=!0,i("mainslider","paused")),!1}),k()){var D=localStorage.getItem("mainslider");"paused"==D?(clearTimeout(x),clearTimeout(y),$(".collegeFeature .timer1").stop(),$(".collegeFeature .timer2").stop(),$(".collegeFeature .timer a").addClass("paused"),C=!0):D="play"}E&&(clearTimeout(x),clearTimeout(y),$(".collegeFeature .timer1").stop(),$(".collegeFeature .timer2").stop(),$(".collegeFeature .timer a").addClass("paused"))}var E={Android:function(){return navigator.userAgent.match(/Android/i)},BlackBerry:function(){return navigator.userAgent.match(/BlackBerry/i)},iOS:function(){return navigator.userAgent.match(/iPhone|iPad|iPod/i)},Opera:function(){return navigator.userAgent.match(/Opera Mini/i)},Windows:function(){return navigator.userAgent.match(/IEMobile/i)},any:function(){return E.Android()||E.BlackBerry()||E.iOS()||E.Opera()||E.Windows()}},F={foo:function(){},bar:function(){},init:function(){function a(){var a=-1;if("Microsoft Internet Explorer"==navigator.appName){var b=navigator.userAgent,c=new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})");null!=c.exec(b)&&(a=parseFloat(RegExp.$1))}else if("Netscape"==navigator.appName){var b=navigator.userAgent,c=new RegExp("Trident/.*rv:([0-9]{1,}[.0-9]{0,})");null!=c.exec(b)&&(a=parseFloat(RegExp.$1))}return a}var b;$(window).resize(function(){clearTimeout(b),b=setTimeout(function(){f()},300)}),$("#nav_sidebar .children").hide(),$("#nav_sidebar li ul.children").prev().addClass("hasChildren"),$("#nav_sidebar .children").delay(300).slideDown(700,function(){}),Function("/*@cc_on return document.documentMode===10@*/")()&&(document.documentElement.className+=" ie10");var c={Android:function(){return navigator.userAgent.match(/Android/i)},BlackBerry:function(){return navigator.userAgent.match(/BlackBerry/i)},iOS:function(){return navigator.userAgent.match(/iPhone|iPad|iPod/i)},Opera:function(){return navigator.userAgent.match(/Opera Mini/i)},Windows:function(){return navigator.userAgent.match(/IEMobile/i)},any:function(){return c.Android()||c.BlackBerry()||c.iOS()||c.Opera()||c.Windows()}};if(a()>0){var d="ie"+a();$("body").addClass(d),$(".ie11 .sheet, .ie11 .sheetbg").css("transition","0.3s"),$(".ie11 .sheet, .ie11 .sheetbg").css("transform","translate3d(-240px,0,0)")}$("#mobile-menu-inner").css("-webkit-transition","0.3s"),$("#mobile-menu-inner").css("-webkit-transform","scale(0.8)"),$("#mobile-filter-inner").css("-webkit-transition","0.3s"),$("#mobile-filter-inner").css("-webkit-transform","scale(0.8)"),$(".mobileScrollTop").click(function(){$(".mobileScroll").animate({scrollTop:0},400)});var e=!1,g=!1;c.iOS()?($("body").addClass("mobile"),$(".mobileNavTrigger").bind("touchstart",function(){return $(this).addClass("touched"),!1}),$(".mobileNavTriggerLarge").bind("touchstart",function(){return e&&($(".home canvas").show(),$(".mobileNavTriggerLarge").hide(),$(".mobileScroll").css("-webkit-transition","0.3s"),$(".mobileScroll").css("-webkit-transform",""),$("#mobile-menu").css("-webkit-transition","0.3s"),$("#mobile-menu").css("-webkit-transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("-webkit-transition","0.3s"),$("#mobile-menu-inner").css("-webkit-transform","scale(0.8)"),$(".mobileScroll").css("-moz-transition","0.3s"),$(".mobileScroll").css("-moz-transform",""),$("#mobile-menu").css("-moz-transition","0.3s"),$("#mobile-menu").css("-moz-transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("-moz-transition","0.3s"),$("#mobile-menu-inner").css("-moz-transform","scale(0.8)"),$(".mobileScroll").css("transition","0.3s"),$(".mobileScroll").css("transform",""),$("#mobile-menu").css("transition","0.3s"),$("#mobile-menu").css("transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("transition","0.3s"),$("#mobile-menu-inner").css("transform","scale(0.8)"),$(".ie11 .sheet, .ie11 .sheetbg").css("transition","0.3s"),$(".ie11 .sheet, .ie11 .sheetbg").css("transform","translate3d(-240px,0,0)"),setTimeout(function(){$("#mobile-filter").show()
},500),e=!1),g&&($(".mobileNavTriggerLarge").hide(),$(".mobileScroll").css("-webkit-transition","0.3s"),$(".mobileScroll").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter").css("-webkit-transition","0.3s"),$("#mobile-filter").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter-inner").css("-webkit-transition","0.3s"),$("#mobile-filter-inner").css("-webkit-transform","scale(0.8)"),setTimeout(function(){$("#mobile-menu").show()},500),g=!1),!1}),$(".mobileNavTrigger").bind("touchend",function(){return $("#mobile-filter").hide(),e?($(".home canvas").show(),$(".mobileNavTriggerLarge").hide(),$(".mobileScroll").css("-webkit-transition","0.3s"),$(".mobileScroll").css("-webkit-transform",""),$("#mobile-menu").css("-webkit-transition","0.3s"),$("#mobile-menu").css("-webkit-transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("-webkit-transition","0.3s"),$("#mobile-menu-inner").css("-webkit-transform","scale(0.8)"),$(".mobileScroll").css("-moz-transition","0.3s"),$(".mobileScroll").css("-moz-transform",""),$("#mobile-menu").css("-moz-transition","0.3s"),$("#mobile-menu").css("-moz-transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("-moz-transition","0.3s"),$("#mobile-menu-inner").css("-moz-transform","scale(0.8)"),$(".mobileScroll").css("transition","0.3s"),$(".mobileScroll").css("transform",""),$("#mobile-menu").css("transition","0.3s"),$("#mobile-menu").css("transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("transition","0.3s"),$("#mobile-menu-inner").css("transform","scale(0.8)"),$(".ie11 .sheet, .ie11 .sheetbg").css("transition","0.3s"),$(".ie11 .sheet, .ie11 .sheetbg").css("transform","translate3d(-240px,0,0)"),setTimeout(function(){$("#mobile-filter").show()},500),e=!1):($(".home canvas").hide(),$(".mobileNavTriggerLarge").show(),$("#mobile-menu-inner").css("-webkit-transition","0.3s"),$("#mobile-menu-inner").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-menu").css("-webkit-transition","0.3s"),$("#mobile-menu").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-menu").css("-moz-transition","0.3s"),$("#mobile-menu").css("-moz-transform","translate3d(0px,0,0)"),$("#mobile-menu-inner").css("-moz-transition","0.3s"),$("#mobile-menu-inner").css("-moz-transform","translate3d(0px,0,0)"),$("#mobile-menu").css("transition","0.3s"),$("#mobile-menu").css("transform","translate3d(0px,0,0)"),$("#mobile-menu-inner").css("transition","0.3s"),$("#mobile-menu-inner").css("transform","translate3d(0px,0,0)"),$(".ie11 .sheet, .ie11 .sheetbg").css("transition","0.3s"),$(".ie11 .sheet, .ie11 .sheetbg").css("transform","translate3d(0px,0,0)"),e=!0,g&&($(".mobileScroll").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter").css("-webkit-transform","translate3d(0px,0,0)"),$(".mobileScroll").css("-moz-transform","translate3d(0px,0,0)"),$("#mobile-filter").css("-moz-transform","translate3d(0px,0,0)"),$(".mobileScroll").css("transform","translate3d(0px,0,0)"),$("#mobile-filter").css("transform","translate3d(0px,0,0)"),g=!1)),$(this).removeClass("touched"),!1}),$(".mobileSettingsTrigger").bind("touchstart",function(){return $(this).addClass("touched"),!1}),$(".mobileSettingsTrigger").bind("touchend",function(){return $("#mobile-menu").hide(),g?($(".mobileNavTriggerLarge").hide(),$(".mobileScroll").css("-webkit-transition","0.3s"),$(".mobileScroll").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter").css("-webkit-transition","0.3s"),$("#mobile-filter").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter-inner").css("-webkit-transition","0.3s"),$("#mobile-filter-inner").css("-webkit-transform","scale(0.8)"),setTimeout(function(){$("#mobile-menu").show()},500),g=!1):($(".mobileNavTriggerLarge").show(),$(".mobileScroll").css("-webkit-transition","0.3s"),$(".mobileScroll").css("-webkit-transform","translate3d(-240px,0,0)"),$("#mobile-filter").css("-webkit-transition","0.3s"),$("#mobile-filter").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter-inner").css("-webkit-transition","0.3s"),$("#mobile-filter-inner").css("-webkit-transform","translate3d(0px,0,0)"),$(".mobileScroll").css("-moz-transition","0.3s"),$(".mobileScroll").css("-moz-transform","translate3d(-240px,0,0)"),$("#mobile-filter").css("-moz-transition","0.3s"),$("#mobile-filter").css("-moz-transform","translate3d(0px,0,0)"),$("#mobile-filter-inner").css("-moz-transition","0.3s"),$("#mobile-filter-inner").css("-moz-transform","translate3d(0px,0,0)"),$(".mobileScroll").css("transition","0.3s"),$(".mobileScroll").css("transform","translate3d(-240px,0,0)"),$("#mobile-filter").css("transition","0.3s"),$("#mobile-filter").css("transform","translate3d(0px,0,0)"),$("#mobile-filter-inner").css("transition","0.3s"),$("#mobile-filter-inner").css("transform","translate3d(0px,0,0)"),$(".ie11 .sheet, .ie11 .sheetbg").css("transition","0.3s"),$(".ie11 .sheet, .ie11 .sheetbg").css("transform","translate3d(-240px,0,0)"),g=!0,e&&($(".mobileScroll").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-menu").css("-webkit-transform","translate3d(0px,0,0)"),$(".mobileScroll").css("-moz-transform","translate3d(0px,0,0)"),$("#mobile-filter").css("-moz-transform","translate3d(0px,0,0)"),$("#mobile-menu").css("-moz-transform","translate3d(0px,0,0)"),$(".mobileScroll").css("transform","translate3d(0px,0,0)"),$("#mobile-filter").css("transform","translate3d(0px,0,0)"),$("#mobile-menu").css("transform","translate3d(0px,0,0)"),$(".ie11 .sheet, .ie11 .sheetbg").css("transition","0.3s"),$(".ie11 .sheet, .ie11 .sheetbg").css("transform","translate3d(0px,0,0)"),e=!1)),$(this).removeClass("touched"),!1})):($(".mobileNavTrigger").bind("click",function(){return $(this).addClass("touched"),!1}),$(".mobileNavTriggerLarge").bind("click",function(){return e&&($(".mobileNavTriggerLarge").hide(),$(".mobileScroll").css("-webkit-transition","0.3s"),$(".mobileScroll").css("-webkit-transform",""),$("#mobile-menu").css("-webkit-transition","0.3s"),$("#mobile-menu").css("-webkit-transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("-webkit-transition","0.3s"),$("#mobile-menu-inner").css("-webkit-transform","scale(0.8)"),$(".mobileScroll").css("-moz-transition","0.3s"),$(".mobileScroll").css("-moz-transform",""),$("#mobile-menu").css("-moz-transition","0.3s"),$("#mobile-menu").css("-moz-transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("-moz-transition","0.3s"),$("#mobile-menu-inner").css("-moz-transform","scale(0.8)"),$(".mobileScroll").css("transition","0.3s"),$(".mobileScroll").css("transform",""),$("#mobile-menu").css("transition","0.3s"),$("#mobile-menu").css("transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("transition","0.3s"),$("#mobile-menu-inner").css("transform","scale(0.8)"),$(".ie11 .sheet, .ie11 .sheetbg").css("transition","0.3s"),$(".ie11 .sheet, .ie11 .sheetbg").css("transform","translate3d(-240px,0,0)"),setTimeout(function(){$("#mobile-filter").show()},500),e=!1),g&&($(".mobileNavTriggerLarge").hide(),$(".mobileScroll").css("-webkit-transition","0.3s"),$(".mobileScroll").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter").css("-webkit-transition","0.3s"),$("#mobile-filter").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter-inner").css("-webkit-transition","0.3s"),$("#mobile-filter-inner").css("-webkit-transform","scale(0.8)"),setTimeout(function(){$("#mobile-menu").show()},500),g=!1),!1}),$(".mobileNavTrigger").bind("click",function(){return $("#mobile-filter").hide(),e?($(".mobileNavTriggerLarge").hide(),$(".mobileScroll").css("-webkit-transition","0.3s"),$(".mobileScroll").css("-webkit-transform",""),$("#mobile-menu").css("-webkit-transition","0.3s"),$("#mobile-menu").css("-webkit-transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("-webkit-transition","0.3s"),$("#mobile-menu-inner").css("-webkit-transform","scale(0.8)"),$(".mobileScroll").css("-moz-transition","0.3s"),$(".mobileScroll").css("-moz-transform",""),$("#mobile-menu").css("-moz-transition","0.3s"),$("#mobile-menu").css("-moz-transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("-moz-transition","0.3s"),$("#mobile-menu-inner").css("-moz-transform","scale(0.8)"),$(".mobileScroll").css("transition","0.3s"),$(".mobileScroll").css("transform",""),$("#mobile-menu").css("transition","0.3s"),$("#mobile-menu").css("transform","translate3d(-240px,0,0)"),$("#mobile-menu-inner").css("transition","0.3s"),$("#mobile-menu-inner").css("transform","scale(0.8)"),$(".ie11 .sheet, .ie11 .sheetbg").css("transition","0.3s"),$(".ie11 .sheet, .ie11 .sheetbg").css("transform","translate3d(-240px,0,0)"),setTimeout(function(){$("#mobile-filter").show()},500),e=!1):($(".mobileNavTriggerLarge").show(),$("#mobile-menu-inner").css("-webkit-transition","0.3s"),$("#mobile-menu-inner").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-menu").css("-webkit-transition","0.3s"),$("#mobile-menu").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-menu").css("-moz-transition","0.3s"),$("#mobile-menu").css("-moz-transform","translate3d(0px,0,0)"),$("#mobile-menu-inner").css("-moz-transition","0.3s"),$("#mobile-menu-inner").css("-moz-transform","translate3d(0px,0,0)"),$("#mobile-menu").css("transition","0.3s"),$("#mobile-menu").css("transform","translate3d(0px,0,0)"),$("#mobile-menu-inner").css("transition","0.3s"),$("#mobile-menu-inner").css("transform","translate3d(0px,0,0)"),$(".ie11 .sheet, .ie11 .sheetbg").css("transition","0.3s"),$(".ie11 .sheet, .ie11 .sheetbg").css("transform","translate3d(0px,0,0)"),e=!0,g&&($(".mobileScroll").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter").css("-webkit-transform","translate3d(0px,0,0)"),g=!1)),$(this).removeClass("touched"),!1}),$(".mobileSettingsTrigger").bind("click",function(){return $(this).addClass("touched"),!1}),$(".mobileSettingsTrigger").bind("click",function(){return $("#mobile-menu").hide(),g?($(".mobileNavTriggerLarge").hide(),$(".mobileScroll").css("-webkit-transition","0.3s"),$(".mobileScroll").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter").css("-webkit-transition","0.3s"),$("#mobile-filter").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter-inner").css("-webkit-transition","0.3s"),$("#mobile-filter-inner").css("-webkit-transform","scale(0.8)"),setTimeout(function(){$("#mobile-menu").show()},500),g=!1):($(".mobileNavTriggerLarge").show(),$(".mobileScroll").css("-webkit-transition","0.3s"),$(".mobileScroll").css("-webkit-transform","translate3d(-240px,0,0)"),$("#mobile-filter").css("-webkit-transition","0.3s"),$("#mobile-filter").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter-inner").css("-webkit-transition","0.3s"),$("#mobile-filter-inner").css("-webkit-transform","translate3d(0px,0,0)"),g=!0,e&&($(".mobileScroll").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-filter").css("-webkit-transform","translate3d(0px,0,0)"),$("#mobile-menu").css("-webkit-transform","translate3d(0px,0,0)"),e=!1)),$(this).removeClass("touched"),!1})),$(window).scroll(function(){var a=$(window).scrollTop();a>=Q?($("#access").addClass("fixedNav"),$("#branding").css("margin-bottom","50px")):($("#access").removeClass("fixedNav"),$("#branding").css("margin-bottom","0px"))}),$(".totop").click(function(){return $("html, body").animate({scrollTop:0},600),!1})}};F.init();var G,H="",I="chronological",J=$("#container"),K=0,L=[],M=[],N=0,O=0,E=!1,P="yes";$("body").addClass(BrowserDetect.browser),"iPhone/iPod"==BrowserDetect.OS?$("body").addClass("iPhone"):$("body").addClass(BrowserDetect.OS),("iPhone/iPod"==BrowserDetect.OS||"Linux"==BrowserDetect.OS&&"Chrome"==BrowserDetect.browser)&&($("body").addClass("mobile"),E=!0),$(".newsItem img").each(function(){K+=1});var Q=$("#access").offset().top;Q="Explorer"==BrowserDetect.browser?Q:Q,$(".newsItem").each(function(){$(this).hasClass("Communities")&&$(this).addClass("People"),0==$(this).hasClass("Communities")&&0==$(this).hasClass("People")&&0==$(this).hasClass("Agriculture")&&0==$(this).hasClass("Energy")&&0==$(this).hasClass("Environment")&&0==$(this).hasClass("Events")&&0==$(this).hasClass("Food")&&0==$(this).hasClass("Health")&&0==$(this).hasClass("social")&&$(this).not(".customize").addClass("Announcements");var a=($(this),$(this).not(".customize").find("img").attr("src")),b=$(this).not(".customize").find("img").parent();"Explorer"!=BrowserDetect.browser;var c=$(this).find(".titleheading").text(),d=$(this).find(".excerpt").text(),f=d.substring(0,50);if(M.push(f),L.push(c),K>0){var g=new Image;$(g).load(function(){N+=1;var a=N/K*100;$(".progress").attr("style","width:"+a+"%;"),N==K&&($(".loadBar").fadeOut(300),e())}).error(function(){b.html("<div class='noImageSpacer2'></div>"),b.next().removeClass("imagePresent"),$(".loadBar").fadeOut(300),e()}).attr("src",a)}else $(".loadBar").fadeOut(300),e()}),J.isotope({masonry:{columnWidth:316},sortBy:"chronological",getSortData:{number:function(a){var b=a.hasClass("newsItem")?a.find(".number").text():a.attr("data-number");return parseInt(b,10)},alphabetical:function(a){var b=a.find("h3"),c=b.length?b:a;return c.text()},chronological:function(a){var b=a.find(".hiddendate").text();return parseInt(b)},grouped:function(a){var b=a.find(".hiddengroup").text();return b}}});{var R=$(".option-set");R.find("a")}if($(".option-set a").click(function(){var a=$(this);if(a.hasClass("selected"))return!1;var b=a.parents(".option-set");b.find(".selected").removeClass("selected"),a.addClass("selected");var c={},d=b.attr("data-option-key"),e=a.attr("data-option-value");return e="false"===e?!1:e,c[d]=e,"layoutMode"===d&&"function"==typeof changeLayoutMode?changeLayoutMode(a,c):J.isotope(c),!1}),k()){var S=localStorage.getItem("categories"),T=localStorage.getItem("sortCat");if(T?($(".categoriesSort a").removeClass("selected"),$(".categoriesSort a").each(function(){$(this).attr("data-cat")==T&&$(this).addClass("selected")}),sortingoptions=T,I=T):T=I,S){for(var U=S.split(","),V=0;V<U.length;V++){if(U[V]){if(U.length>0)var G=G+", ."+U[V];else var G=G;$(".categories .topics a").each(function(){var a=$(this).attr("data-cat");a==U[V]&&$(this).removeClass("selected")})}if(E){var W=$(".categories").first().html();$("#mobile-filter-inner").html(W)}}if("iPhone/iPod"==BrowserDetect.OS||"Linux"==BrowserDetect.OS&&"Chrome"==BrowserDetect.browser||navigator.userAgent.match(/iPhone|iPad|iPod/i)){var G=G+", .customize, .duplicate";e()}var X=U,Y='".newsItem:not(.'+G+')"';H=Y}else{var X=new Array;X.push("duplicate"),("iPhone/iPod"==BrowserDetect.OS||"Linux"==BrowserDetect.OS&&"Chrome"==BrowserDetect.browser)&&(X.push("customize"),e())}if(T&&!S){if("iPhone/iPod"==BrowserDetect.OS||"Linux"==BrowserDetect.OS&&"Chrome"==BrowserDetect.browser||navigator.userAgent.match(/iPhone|iPad|iPod/i))var G=G+", .customize, .duplicate";else var G=G+", .duplicate";var Y='".newsItem:not(.'+G+')"';H=Y,setTimeout(function(){J.isotope({filter:Y,sortBy:T,getSortData:{number:function(a){var b=a.hasClass("newsItem")?a.find(".number").text():a.attr("data-number");return parseInt(b,10)},alphabetical:function(a){var b=a.find("h3"),c=b.length?b:a;return c.text()},chronological:function(a){var b=a.find(".hiddendate").text();return parseInt(b)},grouped:function(a){var b=a.find(".hiddengroup").text();return b}}})},300)}!T&&S&&J.isotope({filter:Y}),T&&S&&setTimeout(function(){J.isotope({filter:Y,sortBy:T,getSortData:{number:function(a){var b=a.hasClass("newsItem")?a.find(".number").text():a.attr("data-number");return parseInt(b,10)},alphabetical:function(a){var b=a.find("h3"),c=b.length?b:a;return c.text()},chronological:function(a){var b=a.find(".hiddendate").text();return parseInt(b)},grouped:function(a){var b=a.find(".hiddengroup").text();return b}}})},300)}$(".categories .topics a.categor, #mobile-filter .topics a.categor").click(function(){if($(this).hasClass("selected")){var a=$(this).attr("data-cat");$(this).removeClass("selected"),X.push(a)}else{var a=$(this).attr("data-cat");$(this).addClass("selected"),X.splice(X.indexOf(a),1)}for(var b=0;b<X.length;b++)if(X[b])if(X.length>0)var c=c+", ."+X[b];else var c=c;var d='".newsItem:not(.'+c+')"';return H=d,J.isotope({filter:d,sortBy:I,getSortData:{number:function(a){var b=a.hasClass("newsItem")?a.find(".number").text():a.attr("data-number");return parseInt(b,10)},alphabetical:function(a){var b=a.find("h3"),c=b.length?b:a;return c.text()},chronological:function(a){var b=a.find(".hiddendate").text();return parseInt(b)},grouped:function(a){var b=a.find(".hiddengroup").text();return b}}}),"yes"==P&&i("categories",X),!1}),$(".categoriesSort a").click(function(){console.log(H),$(".categoriesSort a").removeClass("selected"),$(this).addClass("selected");var a=$(this).attr("data-cat");return I=a,J.isotope({filter:H,sortBy:a,getSortData:{number:function(a){var b=a.hasClass("newsItem")?a.find(".number").text():a.attr("data-number");return parseInt(b,10)},alphabetical:function(a){var b=a.find("h3"),c=b.length?b:a;return c.text()},chronological:function(a){var b=a.find(".hiddendate").text();return parseInt(b)},grouped:function(a){var b=a.find(".hiddengroup").text();return b}}}),"yes"==P&&i("sortCat",a),!1}),$(".remembersettings").click(function(){var a=$(this).attr("data-rem");return"yes"==a?($(this).removeClass("selected"),$(this).attr("data-rem","no"),P="no"):($(this).addClass("selected"),$(this).attr("data-rem","yes"),P="yes"),!1}),$(".catOptions").click(function(){return $(this).next().toggle(),!1}),$("#s").attr("autocomplete","off"),$("#s").keydown(function(a){40==a.keyCode&&(a.preventDefault(),$(".filtered .visible").first().find("a").focus(),$(".filtered .visible").first().addClass("focused"))}),$(".filtered li").keydown(function(a){38==a.keyCode&&(a.preventDefault(),O=parseInt($(".filtered .focused").attr("data-counted"))-1,$(".filtered .visible").each(function(){return $(this).attr("data-counted")==O?($(this).find("a").focus(),$(".filtered .focused").removeClass("focused"),$(this).addClass("focused"),!1):void 0})),40==a.keyCode&&(a.preventDefault(),O=parseInt($(".filtered .focused").attr("data-counted"))+1,$(".filtered .visible").each(function(){return $(this).attr("data-counted")==O?($(this).find("a").focus(),$(".filtered .focused").removeClass("focused"),$(this).addClass("focused"),!1):void 0}))}),"Chrome"!=BrowserDetect.browser?$(".loadingSpinner").hide():($(".loadingSpinner").hide(),$(".newsItem .previousa .highlight").click(function(){$(this).addClass("loading"),$(this).find(".loadingSpinner").show()}));var Z=0;$("#s").keyup(function(){var a=$(this).val(),b=0;$("#cals_uwds-q").attr("value",a),$.ajax({url:"http://www.wisc.edu/directories/json/?jsonp=?",type:"GET",dataType:"json",data:{name:$(this).val(),division:"COLLEGE OF AGRICULTURAL & LIFE SCIENCES"},success:function(a){var b="";null!==a&&(0==a.count?a.errors[0]?4==a.errors[0].code&&(b=""):b="":(Z=a.count,b+="<ul>",$.each(a.records,function(a,c){for(j=0;j<c.titles.length;j++)"COLLEGE OF AGRICULTURAL & LIFE SCIENCES"==c.titles[j].division&&(b+='<li class=""><a href="http://www.wisc.edu/directories/person.php?name='+c.fullName+'" target="_blank"><div class="person_name"><strong>'+c.fullName+"</strong></div>",""!=c.emails[0]&&(b+='<div class="person_email">'+c.emails[0]+"</div>"),""!=c.phones[0]&&(b+='<div class="person_phone">'+c.phones[0]+"</div>"),b+="</a></li>")}),b+="</ul>")),$("#cals_uwds_search_results").html(b),$(".filtered .directory").html(b)},error:function(){$("#cals_uwds_search_results").html("Data could not be retrieved.")}});var c=0;"boredom"==a&&l(),$(".filtered:first li").each(function(){$(this).text().search(new RegExp(a,"i"))<0?($(this).addClass("hidden"),$(this).removeClass("visible")):($(this).removeClass("hidden"),$(this).addClass("visible"),$(".filtered .visible").each(function(){$(this).attr("data-counted",c),c+=1}),b++)}),$("#filter-count").text(b+Z),b+Z>0?($(".filtered").show(),$("#s").addClass("notEmpty")):($("#s").removeClass("notEmpty"),$(".filtered").stop().fadeOut(300)),a.length>0?$(".searchClear").show():$(".searchClear").hide()});var _={};$(".filtered li").each(function(){var a=$(this).text();_[a]?$(this).remove():_[a]=!0});var ab=$("#s").val();if(""!=ab){var bb=$("#s").val(),K=0,cb=0;"boredom"==bb&&l(),$(".filtered:first li").each(function(){$(this).text().search(new RegExp(bb,"i"))<0?($(this).addClass("hidden"),$(this).removeClass("visible")):($(this).removeClass("hidden"),$(this).addClass("visible"),$(".filtered .visible").each(function(){$(this).attr("data-counted",cb),cb+=1}),K++)}),$("#filter-count").text(K),K>0?($("#s").addClass("notEmpty"),$(".filtered").show()):($("#s").removeClass("notEmpty"),$(".filtered").stop().fadeOut(300)),bb.length>0?$(".searchClear").show():$(".searchClear").hide()}$("#s").blur(function(){var a=$(this).attr("value");""==a&&($(".filtered").fadeOut(300),$(".searchClear").hide())}),$(".searchClear").click(function(){return $("#s").attr("value",""),$("#s").removeClass("notEmpty"),$(".filtered").fadeOut(300),$(".searchClear").hide(),!1});var db="no";!function(a){window.MBP=window.MBP||{},MBP.viewportmeta=a.querySelector&&a.querySelector('meta[name="viewport"]'),MBP.ua=navigator.userAgent,MBP.scaleFix=function(){MBP.viewportmeta&&/iPhone|iPad/.test(MBP.ua)&&!/Opera Mini/.test(MBP.ua)&&(MBP.viewportmeta.content="width=device-width, minimum-scale=1.0, maximum-scale=1.0",a.addEventListener("gesturestart",MBP.gestureStart,!1))},MBP.gestureStart=function(){MBP.viewportmeta.content="width=device-width, minimum-scale=0.25, maximum-scale=1.6"},MBP.hideUrlBar=function(){var a=window,b=a.document;if(!location.hash||!a.addEventListener){window.scrollTo(0,1);var c=1,d=setInterval(function(){b.body&&(clearInterval(d),c="scrollTop"in b.body?b.body.scrollTop:1,a.scrollTo(0,1===c?0:1))},15);a.addEventListener("load",function(){setTimeout(function(){a.scrollTo(0,1===c?0:1)},0)},!1)}},MBP.fastButton=function(a,b){this.element=a,this.handler=b,a.addEventListener&&(a.addEventListener("touchstart",this,!1),a.addEventListener("click",this,!1))},MBP.fastButton.prototype.handleEvent=function(a){switch(a.type){case"touchstart":this.onTouchStart(a);break;case"touchmove":this.onTouchMove(a);break;case"touchend":this.onClick(a);break;case"click":this.onClick(a)}},MBP.fastButton.prototype.onTouchStart=function(b){b.stopPropagation(),this.element.addEventListener("touchend",this,!1),a.body.addEventListener("touchmove",this,!1),this.startX=b.touches[0].clientX,this.startY=b.touches[0].clientY,this.element.style.backgroundColor="rgba(0,0,0,.7)"},MBP.fastButton.prototype.onTouchMove=function(a){(Math.abs(a.touches[0].clientX-this.startX)>10||Math.abs(a.touches[0].clientY-this.startY)>10)&&this.reset()},MBP.fastButton.prototype.onClick=function(a){a.stopPropagation(),this.reset(),this.handler(a),"touchend"==a.type&&MBP.preventGhostClick(this.startX,this.startY),this.element.style.backgroundColor=""},MBP.fastButton.prototype.reset=function(){this.element.removeEventListener("touchend",this,!1),a.body.removeEventListener("touchmove",this,!1),this.element.style.backgroundColor=""},MBP.preventGhostClick=function(a,b){MBP.coords.push(a,b),window.setTimeout(function(){MBP.coords.splice(0,2)},2500)},MBP.ghostClickHandler=function(a){for(var b=0,c=MBP.coords.length;c>b;b+=2){var d=MBP.coords[b],e=MBP.coords[b+1];Math.abs(a.clientX-d)<25&&Math.abs(a.clientY-e)<25&&(a.stopPropagation(),a.preventDefault())}},a.addEventListener&&a.addEventListener("click",MBP.ghostClickHandler,!0),MBP.coords=[],MBP.splash=function(){var b="iPad"===navigator.platform?"h/":"l/";a.write('<link rel="apple-touch-startup-image" href="/img/'+b+'splash.png" />')},MBP.autogrow=function(a,b){function c(){var a=this.scrollHeight,b=this.clientHeight;a>b&&(this.style.height=a+3*e+"px")}var d=b?b:12,e=a.currentStyle?a.currentStyle.lineHeight:getComputedStyle(a,null).lineHeight;e=-1==e.indexOf("px")?d:parseInt(e,10),a.style.overflow="hidden",a.addEventListener?a.addEventListener("keyup",c,!1):a.attachEvent("onkeyup",c)}}(document),MBP.hideUrlBar();var eb=navigator.userAgent,fb=/iPhone OS 5/i.test(eb),gb=/iPhone OS 6/i.test(eb);(fb||gb)&&document.body.addEventListener("touchstart",function(){var a=document.getElementsByTagName("div"),b=0;for(b=0;b<=a.length;b++){var c=a[b].className;if("mobileScroll"==c){var d=a[b].scrollTop,e=window.innerHeight,f=d+e;a[b].scrollTop<=0&&(a[b].scrollTop=1),(f==a[b].scrollHeight||f>a[b].scrollHeight)&&(a[b].scrollTop=a[b].scrollTop-1);break}}},!1),$(".post-edit-link").html()&&$(document).keyup(function(a){if(27==a.keyCode){a.preventDefault();var b=$(".post-edit-link").first().attr("href");window.location=b}})}),window.googleLT_||(window.googleLT_=(new Date).getTime()),window.google||(window.google={}),window.google.loader||(window.google.loader={},google.loader.ServiceBase="http://www.google.com/uds",google.loader.GoogleApisBase="http://ajax.googleapis.com/ajax",google.loader.ApiKey="notsupplied",google.loader.KeyVerified=!0,google.loader.LoadFailure=!1,google.loader.Secure=!1,google.loader.GoogleLocale="www.google.com",google.loader.ClientLocation=null,google.loader.AdditionalParams="",function(){function a(a,b){return a.load=b}function b(a){return a in G?G[a]:G[a]=-1!=navigator.userAgent[F]()[v](a)}function c(a,b){var c=function(){};c.prototype=b[A],a.U=b[A],a.prototype=new c}function d(a,b){var c=Array[A].slice.call(arguments,2)||[];return function(){var d=c.concat(Array[A].slice.call(arguments));return a.apply(b,d)}}function e(a){return a=Error(a),a.toString=function(){return this.message},a}function f(a,b){for(var c=a.split(/\./),d=q,e=0;e<c[z]-1;e++)d[c[e]]||(d[c[e]]={}),d=d[c[e]];d[c[c[z]-1]]=b}function g(a,b,c){a[b]=c}function h(a,b,c){if(a.addEventListener)a.addEventListener(b,c,!1);else if(a.attachEvent)a.attachEvent("on"+b,c);else{var d=a["on"+b];a["on"+b]=null!=d?i([c,d]):c}}function i(a){return function(){for(var b=0;b<a[z];b++)a[b]()}}function j(){M[r.readyState]?k():0<L[z]&&q[B](j,10)}function k(){for(var a=0;a<L[z];a++)L[a]();L.length=0}function l(a){this.b=a,this.o=[],this.n={},this.e={},this.f={},this.j=!0,this.c=-1}function m(a){this.F=a,this.q={},this.r=0}function n(a,b,c){this.name=a,this.D=b,this.p=c,this.u=this.h=!1,this.k=[],google[C].v[this[x]]=d(this.l,this)}function o(a,b){this.b=a,this.i=b,this.h=!1}var p=encodeURIComponent,q=window,r=document,s="push",t="replace",u="charAt",v="indexOf",w="ServiceBase",x="name",y="getTime",z="length",A="prototype",B="setTimeout",C="loader",D="substring",E="join",F="toLowerCase",G={};if(!H)var H=f;if(!I)var I=g;google[C].v={},H("google.loader.callbacks",google[C].v);var J={},K={};google[C].eval={},H("google.loader.eval",google[C].eval),a(google,function(a,b,c){function d(a){var b=a.split(".");if(2<b[z])throw e("Module: '"+a+"' not found!");"undefined"!=typeof b[1]&&(f=b[0],c.packages=c.packages||[],c.packages[s](b[1]))}var f=a;if(c=c||{},a instanceof Array||a&&"object"==typeof a&&"function"==typeof a[E]&&"function"==typeof a.reverse)for(var g=0;g<a[z];g++)d(a[g]);else d(a);if(!(a=J[":"+f]))throw e("Module: '"+f+"' not found!");if(c&&!c.language&&c.locale&&(c.language=c.locale),c&&"string"==typeof c.callback&&(g=c.callback,g.match(/^[[\]A-Za-z0-9._]+$/)&&(g=q.eval(g),c.callback=g)),(g=c&&null!=c.callback)&&!a.s(b))throw e("Module: '"+f+"' must be loaded before DOM onLoad!");g?a.m(b,c)?q[B](c.callback,0):a.load(b,c):a.m(b,c)||a.load(b,c)}),H("google.load",google.load),google.T=function(a,c){c?(0==L[z]&&(h(q,"load",k),!b("msie")&&!b("safari")&&!b("konqueror")&&b("mozilla")||q.opera?q.addEventListener("DOMContentLoaded",k,!1):b("msie")?r.write("<script defer onreadystatechange='google.loader.domReady()' src=//:></script>"):(b("safari")||b("konqueror"))&&q[B](j,10)),L[s](a)):h(q,"load",a)},H("google.setOnLoadCallback",google.T);var L=[];google[C].P=function(){var a=q.event.srcElement;"complete"==a.readyState&&(a.onreadystatechange=null,a.parentNode.removeChild(a),k())},H("google.loader.domReady",google[C].P);var M={loaded:!0,complete:!0};google[C].d=function(a,b,c){if(c){var d;"script"==a?(d=r.createElement("script"),d.type="text/javascript",d.src=b):"css"==a&&(d=r.createElement("link"),d.type="text/css",d.href=b,d.rel="stylesheet"),(a=r.getElementsByTagName("head")[0])||(a=r.body.parentNode.appendChild(r.createElement("head"))),a.appendChild(d)}else"script"==a?r.write('<script src="'+b+'" type="text/javascript"></script>'):"css"==a&&r.write('<link href="'+b+'" type="text/css" rel="stylesheet"></link>')},H("google.loader.writeLoadTag",google[C].d),google[C].Q=function(a){K=a},H("google.loader.rfm",google[C].Q),google[C].S=function(a){for(var b in a)"string"==typeof b&&b&&":"==b[u](0)&&!J[b]&&(J[b]=new o(b[D](1),a[b]))},H("google.loader.rpl",google[C].S),google[C].R=function(a){if((a=a.specs)&&a[z])for(var b=0;b<a[z];++b){var c=a[b];"string"==typeof c?J[":"+c]=new l(c):(c=new n(c[x],c.baseSpec,c.customSpecs),J[":"+c[x]]=c)}},H("google.loader.rm",google[C].R),google[C].loaded=function(a){J[":"+a.module].l(a)},H("google.loader.loaded",google[C].loaded),google[C].O=function(){return"qid="+((new Date)[y]().toString(16)+Math.floor(1e7*Math.random()).toString(16))},H("google.loader.createGuidArg_",google[C].O),f("google_exportSymbol",f),f("google_exportProperty",g),google[C].a={},H("google.loader.themes",google[C].a),google[C].a.I="//www.google.com/cse/style/look/bubblegum.css",I(google[C].a,"BUBBLEGUM",google[C].a.I),google[C].a.K="//www.google.com/cse/style/look/greensky.css",I(google[C].a,"GREENSKY",google[C].a.K),google[C].a.J="//www.google.com/cse/style/look/espresso.css",I(google[C].a,"ESPRESSO",google[C].a.J),google[C].a.M="//www.google.com/cse/style/look/shiny.css",I(google[C].a,"SHINY",google[C].a.M),google[C].a.L="//www.google.com/cse/style/look/minimalist.css",I(google[C].a,"MINIMALIST",google[C].a.L),google[C].a.N="//www.google.com/cse/style/look/v2/default.css",I(google[C].a,"V2_DEFAULT",google[C].a.N),l[A].g=function(a,b){var c="";if(void 0!=b&&(void 0!=b.language&&(c+="&hl="+p(b.language)),void 0!=b.nocss&&(c+="&output="+p("nocss="+b.nocss)),void 0!=b.nooldnames&&(c+="&nooldnames="+p(b.nooldnames)),void 0!=b.packages&&(c+="&packages="+p(b.packages)),null!=b.callback&&(c+="&async=2"),void 0!=b.style&&(c+="&style="+p(b.style)),void 0!=b.noexp&&(c+="&noexp=true"),void 0!=b.other_params&&(c+="&"+b.other_params)),!this.j){google[this.b]&&google[this.b].JSHash&&(c+="&sig="+p(google[this.b].JSHash));var d,e=[];for(d in this.n)":"==d[u](0)&&e[s](d[D](1));for(d in this.e)":"==d[u](0)&&this.e[d]&&e[s](d[D](1));c+="&have="+p(e[E](","))}return google[C][w]+"/?file="+this.b+"&v="+a+google[C].AdditionalParams+c},l[A].t=function(a){var b=null;a&&(b=a.packages);var c=null;if(b)if("string"==typeof b)c=[a.packages];else if(b[z])for(c=[],a=0;a<b[z];a++)"string"==typeof b[a]&&c[s](b[a][t](/^\s*|\s*$/,"")[F]());for(c||(c=["default"]),b=[],a=0;a<c[z];a++)this.n[":"+c[a]]||b[s](c[a]);return b},a(l[A],function(a,b){var c=this.t(b),d=b&&null!=b.callback;if(d)var e=new m(b.callback);for(var f=[],g=c[z]-1;g>=0;g--){var h=c[g];d&&e.B(h),this.e[":"+h]?(c.splice(g,1),d&&this.f[":"+h][s](e)):f[s](h)}if(c[z]){for(b&&b.packages&&(b.packages=c.sort()[E](",")),g=0;g<f[z];g++)h=f[g],this.f[":"+h]=[],d&&this.f[":"+h][s](e);if(b||null==K[":"+this.b]||null==K[":"+this.b].versions[":"+a]||google[C].AdditionalParams||!this.j)b&&b.autoloaded||google[C].d("script",this.g(a,b),d);else{c=K[":"+this.b],google[this.b]=google[this.b]||{};for(var i in c.properties)i&&":"==i[u](0)&&(google[this.b][i[D](1)]=c.properties[i]);google[C].d("script",google[C][w]+c.path+c.js,d),c.css&&google[C].d("css",google[C][w]+c.path+c.css,d)}for(this.j&&(this.j=!1,this.c=(new Date)[y](),1!=this.c%100&&(this.c=-1)),g=0;g<f[z];g++)h=f[g],this.e[":"+h]=!0}}),l[A].l=function(a){-1!=this.c&&(T("al_"+this.b,"jl."+((new Date)[y]()-this.c),!0),this.c=-1),this.o=this.o.concat(a.components),google[C][this.b]||(google[C][this.b]={}),google[C][this.b].packages=this.o.slice(0);for(var b=0;b<a.components[z];b++){this.n[":"+a.components[b]]=!0,this.e[":"+a.components[b]]=!1;
var c=this.f[":"+a.components[b]];if(c){for(var d=0;d<c[z];d++)c[d].C(a.components[b]);delete this.f[":"+a.components[b]]}}},l[A].m=function(a,b){return 0==this.t(b)[z]},l[A].s=function(){return!0},m[A].B=function(a){this.r++,this.q[":"+a]=!0},m[A].C=function(a){this.q[":"+a]&&(this.q[":"+a]=!1,this.r--,0==this.r&&q[B](this.F,0))},c(n,l),a(n[A],function(a,b){var c=b&&null!=b.callback;c?(this.k[s](b.callback),b.callback="google.loader.callbacks."+this[x]):this.h=!0,b&&b.autoloaded||google[C].d("script",this.g(a,b),c)}),n[A].m=function(a,b){return b&&null!=b.callback?this.u:this.h},n[A].l=function(){this.u=!0;for(var a=0;a<this.k[z];a++)q[B](this.k[a],0);this.k=[]};var N=function(a,b){return a.string?p(a.string)+"="+p(b):a.regex?b[t](/(^.*$)/,a.regex):""};n[A].g=function(a,b){return this.G(this.w(a),a,b)},n[A].G=function(a,b,c){var d="";if(a.key&&(d+="&"+N(a.key,google[C].ApiKey)),a.version&&(d+="&"+N(a.version,b)),b=google[C].Secure&&a.ssl?a.ssl:a.uri,null!=c)for(var e in c)a.params[e]?d+="&"+N(a.params[e],c[e]):"other_params"==e?d+="&"+c[e]:"base_domain"==e&&(b="http://"+c[e]+a.uri[D](a.uri[v]("/",7)));return google[this[x]]={},-1==b[v]("?")&&d&&(d="?"+d[D](1)),b+d},n[A].s=function(a){return this.w(a).deferred},n[A].w=function(a){if(this.p)for(var b=0;b<this.p[z];++b){var c=this.p[b];if(RegExp(c.pattern).test(a))return c}return this.D},c(o,l),a(o[A],function(a,b){this.h=!0,google[C].d("script",this.g(a,b),!1)}),o[A].m=function(){return this.h},o[A].l=function(){},o[A].g=function(a,b){if(!this.i.versions[":"+a]){if(this.i.aliases){var c=this.i.aliases[":"+a];c&&(a=c)}if(!this.i.versions[":"+a])throw e("Module: '"+this.b+"' with version '"+a+"' not found!")}return google[C].GoogleApisBase+"/libs/"+this.b+"/"+a+"/"+this.i.versions[":"+a][b&&b.uncompressed?"uncompressed":"compressed"]},o[A].s=function(){return!1};var O=!1,P=[],Q=(new Date)[y](),R=function(){O||(h(q,"unload",U),O=!0)},S=function(a,b){if(R(),!(google[C].Secure||google[C].Options&&!1!==google[C].Options.csi)){for(var c=0;c<a[z];c++)a[c]=p(a[c][F]()[t](/[^a-z0-9_.]+/g,"_"));for(c=0;c<b[z];c++)b[c]=p(b[c][F]()[t](/[^a-z0-9_.]+/g,"_"));q[B](d(V,null,"//gg.google.com/csi?s=uds&v=2&action="+a[E](",")+"&it="+b[E](",")),1e4)}},T=function(a,b,c){c?S([a],[b]):(R(),P[s]("r"+P[z]+"="+p(a+(b?"|"+b:""))),q[B](U,5<P[z]?0:15e3))},U=function(){if(P[z]){var a=google[C][w];0==a[v]("http:")&&(a=a[t](/^http:/,"https:")),V(a+"/stats?"+P[E]("&")+"&nc="+(new Date)[y]()+"_"+((new Date)[y]()-Q)),P.length=0}},V=function(a){var b=new Image,c=V.H++;V.A[c]=b,b.onload=b.onerror=function(){delete V.A[c]},b.src=a,b=null};V.A={},V.H=0,f("google.loader.recordCsiStat",S),f("google.loader.recordStat",T),f("google.loader.createImageForLogging",V)}(),google.loader.rm({specs:["feeds","spreadsheets","gdata","visualization",{name:"sharing",baseSpec:{uri:"http://www.google.com/s2/sharing/js",ssl:null,key:{string:"key"},version:{string:"v"},deferred:!1,params:{language:{string:"hl"}}}},"search","orkut","ads","elements",{name:"books",baseSpec:{uri:"http://books.google.com/books/api.js",ssl:"https://encrypted.google.com/books/api.js",key:{string:"key"},version:{string:"v"},deferred:!0,params:{callback:{string:"callback"},language:{string:"hl"}}}},{name:"friendconnect",baseSpec:{uri:"http://www.google.com/friendconnect/script/friendconnect.js",ssl:null,key:{string:"key"},version:{string:"v"},deferred:!1,params:{}}},"identitytoolkit","ima",{name:"maps",baseSpec:{uri:"http://maps.google.com/maps?file=googleapi",ssl:"https://maps-api-ssl.google.com/maps?file=googleapi",key:{string:"key"},version:{string:"v"},deferred:!0,params:{callback:{regex:"callback=$1&async=2"},language:{string:"hl"}}},customSpecs:[{uri:"http://maps.googleapis.com/maps/api/js",ssl:"https://maps.googleapis.com/maps/api/js",version:{string:"v"},deferred:!0,params:{callback:{string:"callback"},language:{string:"hl"}},pattern:"^(3|3..*)$"}]},"payments","wave","annotations_v2","earth","language",{name:"annotations",baseSpec:{uri:"http://www.google.com/reviews/scripts/annotations_bootstrap.js",ssl:null,key:{string:"key"},version:{string:"v"},deferred:!0,params:{callback:{string:"callback"},language:{string:"hl"},country:{string:"gl"}}}},"picker"]}),google.loader.rfm({":search":{versions:{":1":"1",":1.0":"1"},path:"/api/search/1.0/65b21018ad4df09e3eb5a21326b72d0b/",js:"default+en.I.js",css:"default+en.css",properties:{":JSHash":"65b21018ad4df09e3eb5a21326b72d0b",":NoOldNames":!1,":Version":"1.0"}},":language":{versions:{":1":"1",":1.0":"1"},path:"/api/language/1.0/f66252f80431973fa38526a329b0a47b/",js:"default+en.I.js",properties:{":JSHash":"f66252f80431973fa38526a329b0a47b",":Version":"1.0"}},":feeds":{versions:{":1":"1",":1.0":"1"},path:"/api/feeds/1.0/975cfa817ddcf5992ebfc12a1f34c97b/",js:"default+en.I.js",css:"default+en.css",properties:{":JSHash":"975cfa817ddcf5992ebfc12a1f34c97b",":Version":"1.0"}},":spreadsheets":{versions:{":0":"1",":0.4":"1"},path:"/api/spreadsheets/0.4/87ff7219e9f8a8164006cbf28d5e911a/",js:"default.I.js",properties:{":JSHash":"87ff7219e9f8a8164006cbf28d5e911a",":Version":"0.4"}},":ima":{versions:{":3":"1",":3.0":"1"},path:"/api/ima/3.0/28a914332232c9a8ac0ae8da68b1006e/",js:"default.I.js",properties:{":JSHash":"28a914332232c9a8ac0ae8da68b1006e",":Version":"3.0"}},":wave":{versions:{":1":"1",":1.0":"1"},path:"/api/wave/1.0/3b6f7573ff78da6602dda5e09c9025bf/",js:"default.I.js",properties:{":JSHash":"3b6f7573ff78da6602dda5e09c9025bf",":Version":"1.0"}},":annotations":{versions:{":1":"1",":1.0":"1"},path:"/api/annotations/1.0/bacce7b6155a1bbadda3c05d65391b22/",js:"default+en.I.js",properties:{":JSHash":"bacce7b6155a1bbadda3c05d65391b22",":Version":"1.0"}},":earth":{versions:{":1":"1",":1.0":"1"},path:"/api/earth/1.0/109c7b2bae7fe6cc34ea875176165d81/",js:"default.I.js",properties:{":JSHash":"109c7b2bae7fe6cc34ea875176165d81",":Version":"1.0"}},":picker":{versions:{":1":"1",":1.0":"1"},path:"/api/picker/1.0/1c635e91b9d0c082c660a42091913907/",js:"default.I.js",css:"default.css",properties:{":JSHash":"1c635e91b9d0c082c660a42091913907",":Version":"1.0"}}}),google.loader.rpl({":scriptaculous":{versions:{":1.8.3":{uncompressed:"scriptaculous.js",compressed:"scriptaculous.js"},":1.9.0":{uncompressed:"scriptaculous.js",compressed:"scriptaculous.js"},":1.8.2":{uncompressed:"scriptaculous.js",compressed:"scriptaculous.js"},":1.8.1":{uncompressed:"scriptaculous.js",compressed:"scriptaculous.js"}},aliases:{":1.8":"1.8.3",":1":"1.9.0",":1.9":"1.9.0"}},":yui":{versions:{":2.6.0":{uncompressed:"build/yuiloader/yuiloader.js",compressed:"build/yuiloader/yuiloader-min.js"},":2.9.0":{uncompressed:"build/yuiloader/yuiloader.js",compressed:"build/yuiloader/yuiloader-min.js"},":2.7.0":{uncompressed:"build/yuiloader/yuiloader.js",compressed:"build/yuiloader/yuiloader-min.js"},":2.8.0r4":{uncompressed:"build/yuiloader/yuiloader.js",compressed:"build/yuiloader/yuiloader-min.js"},":2.8.2r1":{uncompressed:"build/yuiloader/yuiloader.js",compressed:"build/yuiloader/yuiloader-min.js"},":2.8.1":{uncompressed:"build/yuiloader/yuiloader.js",compressed:"build/yuiloader/yuiloader-min.js"},":3.3.0":{uncompressed:"build/yui/yui.js",compressed:"build/yui/yui-min.js"}},aliases:{":3":"3.3.0",":2":"2.9.0",":2.7":"2.7.0",":2.8.2":"2.8.2r1",":2.6":"2.6.0",":2.9":"2.9.0",":2.8":"2.8.2r1",":2.8.0":"2.8.0r4",":3.3":"3.3.0"}},":swfobject":{versions:{":2.1":{uncompressed:"swfobject_src.js",compressed:"swfobject.js"},":2.2":{uncompressed:"swfobject_src.js",compressed:"swfobject.js"}},aliases:{":2":"2.2"}},":webfont":{versions:{":1.0.28":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.27":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.29":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.12":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.13":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.14":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.15":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.10":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.11":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.2":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.1":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.0":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.6":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.19":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.5":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.18":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.4":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.17":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.3":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.16":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.9":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.21":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.22":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.25":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.26":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.23":{uncompressed:"webfont_debug.js",compressed:"webfont.js"},":1.0.24":{uncompressed:"webfont_debug.js",compressed:"webfont.js"}},aliases:{":1":"1.0.29",":1.0":"1.0.29"}},":ext-core":{versions:{":3.1.0":{uncompressed:"ext-core-debug.js",compressed:"ext-core.js"},":3.0.0":{uncompressed:"ext-core-debug.js",compressed:"ext-core.js"}},aliases:{":3":"3.1.0",":3.0":"3.0.0",":3.1":"3.1.0"}},":mootools":{versions:{":1.3.1":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"},":1.1.1":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"},":1.3.0":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"},":1.3.2":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"},":1.1.2":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"},":1.2.3":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"},":1.2.4":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"},":1.2.1":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"},":1.2.2":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"},":1.2.5":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"},":1.4.0":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"},":1.4.1":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"},":1.4.2":{uncompressed:"mootools.js",compressed:"mootools-yui-compressed.js"}},aliases:{":1":"1.1.2",":1.11":"1.1.1",":1.4":"1.4.2",":1.3":"1.3.2",":1.2":"1.2.5",":1.1":"1.1.2"}},":jqueryui":{versions:{":1.8.0":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.2":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.1":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.15":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.14":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.13":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.12":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.11":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.10":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.17":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.16":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.6.0":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.9":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.7":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.8":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.7.2":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.5":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.7.3":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.6":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.7.0":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.7.1":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.8.4":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.5.3":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"},":1.5.2":{uncompressed:"jquery-ui.js",compressed:"jquery-ui.min.js"}},aliases:{":1.8":"1.8.17",":1.7":"1.7.3",":1.6":"1.6.0",":1":"1.8.17",":1.5":"1.5.3",":1.8.3":"1.8.4"}},":chrome-frame":{versions:{":1.0.2":{uncompressed:"CFInstall.js",compressed:"CFInstall.min.js"},":1.0.1":{uncompressed:"CFInstall.js",compressed:"CFInstall.min.js"},":1.0.0":{uncompressed:"CFInstall.js",compressed:"CFInstall.min.js"}},aliases:{":1":"1.0.2",":1.0":"1.0.2"}},":dojo":{versions:{":1.3.1":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"},":1.3.0":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"},":1.6.1":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"},":1.1.1":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"},":1.3.2":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"},":1.6.0":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"},":1.2.3":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"},":1.7.2":{uncompressed:"dojo/dojo.js.uncompressed.js",compressed:"dojo/dojo.js"},":1.7.0":{uncompressed:"dojo/dojo.js.uncompressed.js",compressed:"dojo/dojo.js"},":1.7.1":{uncompressed:"dojo/dojo.js.uncompressed.js",compressed:"dojo/dojo.js"},":1.4.3":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"},":1.5.1":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"},":1.5.0":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"},":1.2.0":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"},":1.4.0":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"},":1.4.1":{uncompressed:"dojo/dojo.xd.js.uncompressed.js",compressed:"dojo/dojo.xd.js"}},aliases:{":1.7":"1.7.2",":1":"1.6.1",":1.6":"1.6.1",":1.5":"1.5.1",":1.4":"1.4.3",":1.3":"1.3.2",":1.2":"1.2.3",":1.1":"1.1.1"}},":prototype":{versions:{":1.7.0.0":{uncompressed:"prototype.js",compressed:"prototype.js"},":1.6.0.2":{uncompressed:"prototype.js",compressed:"prototype.js"},":1.6.1.0":{uncompressed:"prototype.js",compressed:"prototype.js"},":1.6.0.3":{uncompressed:"prototype.js",compressed:"prototype.js"}},aliases:{":1.7":"1.7.0.0",":1.6.1":"1.6.1.0",":1":"1.7.0.0",":1.6":"1.6.1.0",":1.7.0":"1.7.0.0",":1.6.0":"1.6.0.3"}},":jquery":{versions:{":1.6.2":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.3.1":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.6.1":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.3.0":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.6.4":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.6.3":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.3.2":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.6.0":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.2.3":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.7.0":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.7.1":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.2.6":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.4.3":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.4.4":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.5.1":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.5.0":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.4.0":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.5.2":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.4.1":{uncompressed:"jquery.js",compressed:"jquery.min.js"},":1.4.2":{uncompressed:"jquery.js",compressed:"jquery.min.js"}},aliases:{":1.7":"1.7.1",":1.6":"1.6.4",":1":"1.7.1",":1.5":"1.5.2",":1.4":"1.4.4",":1.3":"1.3.2",":1.2":"1.2.6"}}})),$(document).ready(function(){$(".slideImage").each(function(){var a=$(this).css("background-image");$(this).find(".slideBlurImage").css("background-image",a),$(this).find(".headerbgBlurImage").css("background-image",a)}),$(".headershade").addClass("fadeOut"),setTimeout(function(){$(".headershade").hide()},3e3);var a=$(".slideBlur"),b=a.offset(),c="0px -"+b.top+"px",d=$(".headerbgBlur"),e=d.offset(),f=$(".headeroverlay"),g=f.offset(),h="-"+g.left+"px -"+e.top+"px";$(".slideBlurImage").css("background-position",c),$(".headerbgBlurImage").css("background-position",h)}),$(document).ready(function(){$(".accordion-header").toggleClass("inactive-header");var a=$(".accordion-header").width();return $(".accordion-content").css({width:a}),$(".accordion-header").first().toggleClass("active-header").toggleClass("inactive-header"),$(".accordion-content").first().slideDown().toggleClass("open-content"),$(".accordion-header").click(function(){$(this).is(".inactive-header")?($(".active-header").toggleClass("active-header").toggleClass("inactive-header").next().slideToggle().toggleClass("open-content"),$(this).toggleClass("active-header").toggleClass("inactive-header"),$(this).next().slideToggle().toggleClass("open-content")):($(this).toggleClass("active-header").toggleClass("inactive-header"),$(this).next().slideToggle().toggleClass("open-content"))}),!1});