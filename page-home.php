...
<?php if( have_rows('home_page_feature') ):
    ...
    while ( have_rows('home_page_feature') ) : the_row();
        ...
        if( get_row_layout() == 'full_width_promotion' ): ?>
			<?php $formatting = get_sub_field('promotion_formatting'); ?>
        	<?php if($formatting[0] == "untreated" ) { ?>
				<div class="row clearfix">




						<div class="span-100 box dropin homepromo">
							...
							<?php if(get_sub_field('promotion_link_url') != "") { ?>
							<a href="<?php the_sub_field('promotion_link_url'); ?>" rel="bookmark" class="hideTextFullSize" title="Permanent Link to Title"><?php the_sub_field('promotion_title'); ?></a>
							<?php } else { ?>
							<a href="<?php the_sub_field('promotion_link'); ?>" rel="bookmark" class="hideTextFullSize" title="Permanent Link to Title"><?php the_sub_field('promotion_title'); ?></a>
							<?php } ?>
